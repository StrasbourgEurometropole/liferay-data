<nav class="nav-lang">
    <div class="center"> <a href="${logoLink.getData()}" title="${logoLinkTitle.getData()}" class="logo-strasbourg" target="_blank"> <img src="${logo.getData()}" alt="${logoLinkTitle.getData()}"> </a>
        <ul>
