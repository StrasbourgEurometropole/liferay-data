...
@media (max-width: 480px) {
    ...
    .see .extra-heading, .see .uppercase, .see h5.heading-alt {
...
<section id="hero" class="hero-section bg1 bg-cover window-height light-text">
  ...
  <div class="heading-block centered-block align-center">
    <div class="container">
      <h5 class="heading-alt" style="letter-spacing: .3em; margin-bottom: 8px;"><span class="fa fa-calendar-o base-clr-txt"></span>${date.getData()}<span class="fa fa-map-marker base-clr-txt" style="margin-left: 14px;"></span>${place.getData()}</h5>
