                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pull-right order-1">
                        <a href="${sibling.children[3].data}">
                            ...
                            <figure class="mns-wrapper-img mns-wrapper-img-top2">
                                <img src="${sibling.children[4].data}" alt="${sibling.children[0].data}" class="fit-cover" />
                            </figure>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-6 col-xs-12 pull-right order-1">
                        ...
                        <a href="${sibling.children[3].data}">
                            ...
                            <figure class="mns-wrapper-img mns-wrapper-img-top1">
                                <#if sibling?counter = 1 >
                                    <img src="${sibling.children[4].data}" alt="${sibling.children[0].data}" width="670" height="750" class="fit-cover" />
                                <#else >
                                    <img src="${sibling.children[4].data}" alt="${sibling.children[0].data}" class="fit-cover"/>
                                </#if>
                            </figure>
                        ...
                        <a href="${sibling.children[3].data}">
                            ...
                            <figure class="mns-wrapper-img mns-wrapper-img-top2">
                                <#if sibling?counter = 2 >
                                    <img src="${sibling.children[4].data}" alt="${sibling.children[0].data}" width="570" height="570" class="fit-cover" />
                                <#else>
                                    <img src="${sibling.children[4].data}" alt="${sibling.children[0].data}" class="fit-cover" />
                                </#if>
                            </figure>
