...
<div class="pro-page-pacte">
    ...
    <div class="container">
        <div>
                                    ...
                                    <li>
                                        <a href="${file.getData()}" download title="${title}">
                                            ...
                                            <div>
                                                ...
                                                <span class="pro-file-size">(PDF - ${size}KB)</span>
                                            </div>
                                        </a>
                                    </li>
            ...
            <div class="row pro-wrapper-pacte pt-3">
                <div class="col-md-6">
...
<div class="row justify-content-center">
    <div class="col-lg-10 col-md-12">
        <div><h2>Les articles du Pacte</h2></div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="heading${cur_title?index}">
                        <h3 class="panel-title">
                            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse${cur_title?index}" aria-expanded="false" aria-controls="collapse${cur_title?index}" title="Nom de l'article">
                                ${cur_title.getData()}
                            </a>
                        </h3>
                    </div>
                    <div id="collapse${cur_title?index}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading${cur_title?index}">
