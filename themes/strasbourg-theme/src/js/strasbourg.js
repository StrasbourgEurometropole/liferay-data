...
window.cookieconsent.initialise({
    ...
    content: {
        header: 'Cookies utilisés sur ce site',
        message: '<div>En poursuivant la navigation sur ce site, vous acceptez l\'utilisation de cookies permettant d\'améliorer votre expérience utilisateur.</div>',
