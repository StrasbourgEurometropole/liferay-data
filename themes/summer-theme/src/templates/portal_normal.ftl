...
<@liferay.control_menu />
					...
					<nav class="nav-lang">
						<div class="center">
							...
							<ul>
								...
								<li <#if locale.language == "fr"> class="active" </#if> ><a accesskey="1" href="/fr${currURL}${layout.friendlyURL}" title="Fran�ais">FR</a></li>
    ...
    <script src="${javascript_folder}/vendor/owl.carousel.min.js"></script>
