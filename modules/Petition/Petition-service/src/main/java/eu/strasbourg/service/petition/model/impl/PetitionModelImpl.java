...
import eu.strasbourg.service.petition.model.PetitionModel;
import eu.strasbourg.service.petition.model.PetitionSoap;
...
/**
 * The base model implementation for the Petition service. Represents a row in the &quot;petition_Petition&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class PetitionModelImpl extends BaseModelImpl<Petition>
	 ...
	 */
	public static final String TABLE_NAME = "petition_Petition";
	...
	public static final String TABLE_SQL_CREATE = "create table petition_Petition (uuid_ VARCHAR(75) null,petitionId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,status INTEGER,statusByUserId LONG,statusByUserName VARCHAR(75) null,statusDate DATE null,title VARCHAR(75) null,videoURL VARCHAR(75) null,pictureURL VARCHAR(75) null,isVideo BOOLEAN,description VARCHAR(75) null,placeTextArea VARCHAR(75) null,filesDownload VARCHAR(75) null,publicationDate DATE null,expirationDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table petition_Petition";
	public static final String ORDER_BY_JPQL = " ORDER BY petition.title ASC";
	public static final String ORDER_BY_SQL = " ORDER BY petition_Petition.title ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(eu.strasbourg.service.petition.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.eu.strasbourg.service.petition.model.Petition"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(eu.strasbourg.service.petition.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.eu.strasbourg.service.petition.model.Petition"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(eu.strasbourg.service.petition.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.eu.strasbourg.service.petition.model.Petition"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(eu.strasbourg.service.petition.service.util.ServiceProps.get(
				"lock.expiration.time.eu.strasbourg.service.petition.model.Petition"));
	...
	public String toXmlString() {
		...
		sb.append("eu.strasbourg.service.petition.model.Petition");
