...
@Component(
	...
	property = {
		...
		"mvc.command.name=changeStatusHelpProposal"
	},
	service = MVCActionCommand.class
)
public class ChangeStatusHelpActionCommand implements MVCActionCommand {
	...
	public boolean processAction(ActionRequest request, ActionResponse response)
		...
		try {
			...
			int helpProposalNewStatus = ParamUtil.getInteger(request, "status");
			HelpProposal helpProposal = _helpProposalLocalService.getHelpProposal(helpProposalId);
			_helpProposalLocalService.updateStatus(helpProposal, helpProposalNewStatus);
