    ...
    >
        ...
        >
            ...
            <liferay-ui:search-container-column-text name="">
                <div class="data" data-id="${helpProposal.helpProposalId}" data-title="${helpProposal.title}"></div>
...
<aui:script>
    $('.helpProposal-row input[type=checkbox]').on('change', function() {
