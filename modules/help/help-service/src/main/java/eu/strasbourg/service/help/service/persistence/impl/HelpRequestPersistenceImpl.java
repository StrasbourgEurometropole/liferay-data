...
public class HelpRequestPersistenceImpl
	...
	public List<HelpRequest> findByUuid(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				query.append(HelpRequestModelImpl.ORDER_BY_JPQL);
			}
	...
	public List<HelpRequest> findByHelpProposalId(
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_HELPPROPOSALID_HELPPROPOSALID_2);
	...
	public HelpRequest create(long helpRequestId) {
		...
		helpRequest.setCompanyId(companyProvider.getCompanyId());
	...
	public HelpRequest remove(Serializable primaryKey)
		...
		catch (NoSuchHelpRequestException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	public List<HelpRequest> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				query.append(_SQL_SELECT_HELPREQUEST);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_HELPREQUEST);
