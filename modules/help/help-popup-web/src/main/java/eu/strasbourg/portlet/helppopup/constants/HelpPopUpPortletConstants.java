package eu.strasbourg.portlet.helppopup.constants;

public class HelpPopUpPortletConstants {
    ...
    /**
     * Pop-up : nouvelle proposition d'aide
     */
    // Paramètres
    ...
    public static final String IN_THE_NAME_OF = "inTheNameOf";
    ...
    public static final String ERROR_PRESENTATION = "error-presentation";
    public static final String ERROR_ADDRESS = "error-address";
    public static final String ERROR_CITY = "error-city";
    public static final String ERROR_POSTAL_CODE = "error-postal-code";
    public static final String ERROR_PHONE_NUMBER = "error-phone-number";
    public static final String ERROR_HELP_TYPE = "error-help-type";
