...
public interface AgendaLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AgendaLocalServiceUtil} to access the agenda local service. Add custom service methods to <code>eu.strasbourg.service.csmap.service.impl.AgendaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
