...
public class ThematicPersistenceImpl
	...
	public List<Thematic> findByUuid(
		...
		if (list == null) {
			...
			query.append(_SQL_SELECT_THEMATIC_WHERE);
			...
			if (orderByComparator != null) {
				...
				query.append(ThematicModelImpl.ORDER_BY_JPQL);
			}
	...
	public Thematic findByUuid_First(
		...
		throw new NoSuchThematicException(msg.toString());
	}
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			query.append(_SQL_COUNT_THEMATIC_WHERE);
	...
	public Thematic remove(Serializable primaryKey)
		...
		catch (NoSuchThematicException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	public List<Thematic> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				query.append(_SQL_SELECT_THEMATIC);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_THEMATIC);
