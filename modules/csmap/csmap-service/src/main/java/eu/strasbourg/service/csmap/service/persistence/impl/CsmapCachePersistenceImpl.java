...
public class CsmapCachePersistenceImpl
	...
	public CsmapCache findByCodeCache(long codeCache)
		...
		if (csmapCache == null) {
			...
			throw new NoSuchCsmapCacheException(msg.toString());
		}
	 ...
	 */
	@Override
	public CsmapCache fetchByCodeCache(
		...
		if (result == null) {
			...
			query.append(_SQL_SELECT_CSMAPCACHE_WHERE);

			query.append(_FINDER_COLUMN_CODECACHE_CODECACHE_2);
	...
	public int countByCodeCache(long codeCache) {
		...
		if (count == null) {
			...
			query.append(_SQL_COUNT_CSMAPCACHE_WHERE);
	...
	public List<CsmapCache> findByLastProcessNotSuccess(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				query.append(CsmapCacheModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				qPos.add(isLastProcessSuccess.booleanValue());
	...
	public CsmapCache findByLastProcessNotSuccess_First(
		...
		msg.append("isLastProcessSuccess=");
		msg.append(isLastProcessSuccess);
	...
	public CsmapCache remove(Serializable primaryKey)
		...
		catch (NoSuchCsmapCacheException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	public List<CsmapCache> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				query.append(_SQL_SELECT_CSMAPCACHE);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_CSMAPCACHE);
