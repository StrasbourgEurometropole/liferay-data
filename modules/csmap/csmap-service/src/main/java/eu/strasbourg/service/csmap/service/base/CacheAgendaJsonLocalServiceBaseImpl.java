...
/**
 * Provides the base implementation for the cache agenda json local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.csmap.service.impl.CacheAgendaJsonLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see eu.strasbourg.service.csmap.service.impl.CacheAgendaJsonLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class CacheAgendaJsonLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements CacheAgendaJsonLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CacheAgendaJsonLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>eu.strasbourg.service.csmap.service.CacheAgendaJsonLocalServiceUtil</code>.
	 */
	...
	public CacheAgendaJson addCacheAgendaJson(CacheAgendaJson cacheAgendaJson) {
		...
		return cacheAgendaJsonPersistence.update(cacheAgendaJson);
	}
	...
	public CacheAgendaJson createCacheAgendaJson(long cacheId) {
		return cacheAgendaJsonPersistence.create(cacheId);
	}
	...
	public CacheAgendaJson deleteCacheAgendaJson(long cacheId)
		...
		return cacheAgendaJsonPersistence.remove(cacheId);
	}
	...
	public CacheAgendaJson deleteCacheAgendaJson(
		...
		return cacheAgendaJsonPersistence.remove(cacheAgendaJson);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CacheAgendaJson.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return cacheAgendaJsonPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return cacheAgendaJsonPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return cacheAgendaJsonPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return cacheAgendaJsonPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public CacheAgendaJson fetchCacheAgendaJson(long cacheId) {
		return cacheAgendaJsonPersistence.fetchByPrimaryKey(cacheId);
	}
	...
	public CacheAgendaJson getCacheAgendaJson(long cacheId)
		...
		return cacheAgendaJsonPersistence.findByPrimaryKey(cacheId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(cacheAgendaJsonLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CacheAgendaJson.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			cacheAgendaJsonLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CacheAgendaJson.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return cacheAgendaJsonLocalService.deleteCacheAgendaJson(
			(CacheAgendaJson)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return cacheAgendaJsonPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CacheAgendaJson> getCacheAgendaJsons(int start, int end) {
		return cacheAgendaJsonPersistence.findAll(start, end);
	}
	...
	public int getCacheAgendaJsonsCount() {
		return cacheAgendaJsonPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CacheAgendaJsonLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		cacheAgendaJsonLocalService = (CacheAgendaJsonLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CacheAgendaJsonLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cacheAgendaJsonPersistence.getDataSource();
	...
	protected CacheAgendaJsonLocalService cacheAgendaJsonLocalService;
