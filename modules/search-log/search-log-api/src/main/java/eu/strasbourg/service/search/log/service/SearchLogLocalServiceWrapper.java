 ...
 */
@ProviderType
public class SearchLogLocalServiceWrapper implements SearchLogLocalService,
	ServiceWrapper<SearchLogLocalService> {
	...
	*/
	...
	public eu.strasbourg.service.search.log.model.SearchLog addSearchLog(
		...
		long searchTime)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _searchLogLocalService.addSearchLog(sc, keywords, resultCount,
			result1, result2, result3, userTargetResult, searchTime);
	}
	...
	*/
	@Override
	public java.util.List<eu.strasbourg.service.search.log.model.SearchLog> getSearchLogs(
		int start, int end) {
	...
	*/
	...
	public long dynamicQueryCount(
		...
		return _searchLogLocalService.dynamicQueryCount(dynamicQuery, projection);
	}
