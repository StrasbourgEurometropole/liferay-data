...
<div>
    <aui:select id="includeOrExclude_${param.assetTypeIndex}_${param.ruleIndex}" name="includeOrExclude_${param.assetTypeIndex}_${param.index}" inlineField="true" label="">
