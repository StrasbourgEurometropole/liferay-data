...
public class SubPlaceUtil {
	...
	public static List<SubPlace> findByPlaceId(
		...
		return getPersistence().findByPlaceId(
			placeId, start, end, orderByComparator, retrieveFromCache);
	}
	...
	private static ServiceTracker<SubPlacePersistence, SubPlacePersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(SubPlacePersistence.class);

		ServiceTracker<SubPlacePersistence, SubPlacePersistence>
			serviceTracker =
				new ServiceTracker<SubPlacePersistence, SubPlacePersistence>(
					bundle.getBundleContext(), SubPlacePersistence.class, null);
