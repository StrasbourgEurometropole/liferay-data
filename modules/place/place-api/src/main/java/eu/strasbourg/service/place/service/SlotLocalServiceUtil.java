 ...
 * {@link eu.strasbourg.service.place.service.impl.SlotLocalServiceImpl} and is the
 ...
 * @see eu.strasbourg.service.place.service.base.SlotLocalServiceBaseImpl
...
public class SlotLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link eu.strasbourg.service.place.service.impl.SlotLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	* @return the new slot
	*/
	public static eu.strasbourg.service.place.model.Slot createSlot(long slotId) {
	...
	*/
	...
	public static eu.strasbourg.service.place.model.Slot fetchSlot(long slotId) {
	...
	*/
	public static java.util.List<eu.strasbourg.service.place.model.Slot> getSlots(
		int start, int end) {
	...
	*/
	...
	private static ServiceTracker<SlotLocalService, SlotLocalService> _serviceTracker =
		ServiceTrackerFactory.open(SlotLocalService.class);
}