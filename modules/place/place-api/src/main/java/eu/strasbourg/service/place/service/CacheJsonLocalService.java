...
public interface CacheJsonLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CacheJsonLocalServiceUtil} to access the cache json local service. Add custom service methods to <code>eu.strasbourg.service.place.service.impl.CacheJsonLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
