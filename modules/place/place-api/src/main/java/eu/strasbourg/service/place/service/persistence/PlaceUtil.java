...
public class PlaceUtil {
	...
	public static List<Place> findByPriceId(
		...
		return getPersistence().findByPriceId(
			priceId, start, end, orderByComparator, retrieveFromCache);
	}
	 ...
	 * @return the matching place, or <code>null</code> if a matching place could not be found
	 */
	public static Place fetchBySIGId(String SIGid, boolean retrieveFromCache) {
	...
	private static ServiceTracker<PlacePersistence, PlacePersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(PlacePersistence.class);

		ServiceTracker<PlacePersistence, PlacePersistence> serviceTracker =
			new ServiceTracker<PlacePersistence, PlacePersistence>(
				bundle.getBundleContext(), PlacePersistence.class, null);
