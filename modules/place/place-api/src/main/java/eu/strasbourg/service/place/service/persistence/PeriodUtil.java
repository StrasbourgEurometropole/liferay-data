...
public class PeriodUtil {
	...
	* @return the matching periods
	*/
	public static List<Period> findBySubPlaceId(long subPlaceId) {
	...
	* @return the range of matching periods
	*/
	public static List<Period> findBySubPlaceId(long subPlaceId, int start,
		int end) {
	...
	* @throws NoSuchPeriodException if a matching period could not be found
	*/
	public static Period findBySubPlaceId_First(long subPlaceId,
		OrderByComparator<Period> orderByComparator)
		throws eu.strasbourg.service.place.exception.NoSuchPeriodException {
		return getPersistence()
	...
	* @return the first matching period, or <code>null</code> if a matching period could not be found
	*/
	public static Period fetchBySubPlaceId_First(long subPlaceId,
		OrderByComparator<Period> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchPeriodException if a matching period could not be found
	*/
	public static Period findBySubPlaceId_Last(long subPlaceId,
		OrderByComparator<Period> orderByComparator)
		throws eu.strasbourg.service.place.exception.NoSuchPeriodException {
		return getPersistence()
	...
	* @return the last matching period, or <code>null</code> if a matching period could not be found
	*/
	public static Period fetchBySubPlaceId_Last(long subPlaceId,
		OrderByComparator<Period> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchPeriodException if a period with the primary key could not be found
	*/
	public static Period[] findBySubPlaceId_PrevAndNext(long periodId,
		long subPlaceId, OrderByComparator<Period> orderByComparator)
		throws eu.strasbourg.service.place.exception.NoSuchPeriodException {
		return getPersistence()
				   .findBySubPlaceId_PrevAndNext(periodId, subPlaceId,
			orderByComparator);
	}
