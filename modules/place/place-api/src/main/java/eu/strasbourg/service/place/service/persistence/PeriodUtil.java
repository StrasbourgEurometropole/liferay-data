...
public class PeriodUtil {
	...
	private static ServiceTracker<PeriodPersistence, PeriodPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(PeriodPersistence.class);

		ServiceTracker<PeriodPersistence, PeriodPersistence> serviceTracker =
			new ServiceTracker<PeriodPersistence, PeriodPersistence>(
				bundle.getBundleContext(), PeriodPersistence.class, null);
