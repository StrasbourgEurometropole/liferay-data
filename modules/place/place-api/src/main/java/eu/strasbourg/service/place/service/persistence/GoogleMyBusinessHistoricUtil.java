...
/**
 * The persistence utility for the google my business historic service. This utility wraps {@link eu.strasbourg.service.place.service.persistence.impl.GoogleMyBusinessHistoricPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class GoogleMyBusinessHistoricUtil {
	...
	public static GoogleMyBusinessHistoric update(
		...
		return getPersistence().update(googleMyBusinessHistoric, serviceContext);
	}
	...
	*/
	public static GoogleMyBusinessHistoric findByUuid_First(
		java.lang.String uuid,
		OrderByComparator<GoogleMyBusinessHistoric> orderByComparator)
		throws eu.strasbourg.service.place.exception.NoSuchGoogleMyBusinessHistoricException {
	...
	*/
	public static GoogleMyBusinessHistoric[] findByUuid_PrevAndNext(
		...
		throws eu.strasbourg.service.place.exception.NoSuchGoogleMyBusinessHistoricException {
		return getPersistence()
				   .findByUuid_PrevAndNext(googleMyBusinessHistoricId, uuid,
			orderByComparator);
	}
	...
	* @throws NoSuchGoogleMyBusinessHistoricException if a matching google my business historic could not be found
	*/
	public static GoogleMyBusinessHistoric findByUUID_G(java.lang.String uuid,
		long groupId)
		throws eu.strasbourg.service.place.exception.NoSuchGoogleMyBusinessHistoricException {
	...
	*/
	public static GoogleMyBusinessHistoric[] findByUuid_C_PrevAndNext(
		...
		throws eu.strasbourg.service.place.exception.NoSuchGoogleMyBusinessHistoricException {
		return getPersistence()
				   .findByUuid_C_PrevAndNext(googleMyBusinessHistoricId, uuid,
	...
	* @throws NoSuchGoogleMyBusinessHistoricException if a matching google my business historic could not be found
	*/
	public static GoogleMyBusinessHistoric findByGroupId_First(long groupId,
		OrderByComparator<GoogleMyBusinessHistoric> orderByComparator)
		throws eu.strasbourg.service.place.exception.NoSuchGoogleMyBusinessHistoricException {
	...
	* @return the first matching google my business historic, or <code>null</code> if a matching google my business historic could not be found
	*/
	public static GoogleMyBusinessHistoric fetchByGroupId_First(long groupId,
		OrderByComparator<GoogleMyBusinessHistoric> orderByComparator) {
	...
	* @throws NoSuchGoogleMyBusinessHistoricException if a matching google my business historic could not be found
	*/
	public static GoogleMyBusinessHistoric findByGroupId_Last(long groupId,
		OrderByComparator<GoogleMyBusinessHistoric> orderByComparator)
		throws eu.strasbourg.service.place.exception.NoSuchGoogleMyBusinessHistoricException {
	...
	* @return the last matching google my business historic, or <code>null</code> if a matching google my business historic could not be found
	*/
	public static GoogleMyBusinessHistoric fetchByGroupId_Last(long groupId,
		OrderByComparator<GoogleMyBusinessHistoric> orderByComparator) {
	...
	*/
	public static GoogleMyBusinessHistoric[] findByGroupId_PrevAndNext(
		...
		throws eu.strasbourg.service.place.exception.NoSuchGoogleMyBusinessHistoricException {
		return getPersistence()
				   .findByGroupId_PrevAndNext(googleMyBusinessHistoricId,
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, GoogleMyBusinessHistoric> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<GoogleMyBusinessHistoricPersistence, GoogleMyBusinessHistoricPersistence> _serviceTracker =
		ServiceTrackerFactory.open(GoogleMyBusinessHistoricPersistence.class);
}