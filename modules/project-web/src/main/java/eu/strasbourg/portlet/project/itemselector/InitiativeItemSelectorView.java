...
public class InitiativeItemSelectorView  implements ItemSelectorView<InitiativeItemSelectorCriterion> {
	...
	@Override
	public Class<InitiativeItemSelectorCriterion> getItemSelectorCriterionClass() {
		return InitiativeItemSelectorCriterion.class;
	}
	...
	public void renderHTML(ServletRequest servletRequest,
		...
		InitiativeItemSelectorCriterion itemSelectorCriterion,
		PortletURL portletURL, String itemSelectedInitiativeName, boolean search)
		...
		servletRequest.setAttribute("total", initiativesCount);
		servletRequest.setAttribute("initiatives", Initiatives);
		servletRequest.setAttribute("portletURL", portletURL);
		servletRequest.setAttribute("itemSelectedInitiativeName",
			itemSelectedInitiativeName);
		...
		RequestDispatcher requestDispatcher = servletContext
			.getRequestDispatcher(
				"/initiative/item-selector/initiative-item-selector.jsp");
