...
public class InitiativeAssetRenderer extends BaseJSPAssetRenderer<Initiative> {

	
	public static final String TYPE = "initiative";
	private Initiative _entry;
	
	public InitiativeAssetRenderer(Initiative entry){
		_entry = entry;
	}
	
	@Override
	public Initiative getAssetObject() {
		return _entry;
	}
