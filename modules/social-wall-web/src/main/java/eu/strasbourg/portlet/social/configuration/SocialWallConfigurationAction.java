...
public class SocialWallConfigurationAction extends DefaultConfigurationAction {
	...
	public void processAction(PortletConfig portletConfig,
		...
		String instagramAccount = ParamUtil.getString(actionRequest, "instagramAccount");
		setPreference(actionRequest, "instagramAccount", instagramAccount);
		...
		MultiVMPoolUtil.getPortalCache("instagram_cache").remove(instagramAccount);
		MultiVMPoolUtil.getPortalCache("instagram_cache")
			.remove(instagramAccount + "_last_update");
	...
	public void include(PortletConfig portletConfig, HttpServletRequest request,
		...
		try {
			...
			request.setAttribute("instagramAccount", configuration.instagramAccount());
