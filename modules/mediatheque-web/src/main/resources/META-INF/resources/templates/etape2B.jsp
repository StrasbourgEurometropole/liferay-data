...
<section id="mediatheque">
    ...
    <h2>${title}</h2>
		...
		<div align="center">
			<a href="<liferay-ui:message key="no-mail-url" />" class="btn-square--bordered--core" target="_blank" title="<liferay-ui:message key="site-mediatheques" /> (<liferay-ui:message key="eu.new-window" />)">
				<span class="flexbox">
