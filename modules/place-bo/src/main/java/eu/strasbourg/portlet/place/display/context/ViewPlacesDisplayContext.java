...
public class ViewPlacesDisplayContext {
	...
	public SearchContainer<Place> getSearchContainer() throws PortalException {
		...
		iteratorURL.setParameter("tab", "places");
	...
	public String getOrderByColSearchField() {
		...
		case "alias":
			return "localized_alias_fr_FR_sortable";
		case "modified-date":
	...
	public String[] getOrderColumns() {
		return new String[] { "alias", "modified-date" };
	}
	...
	private SearchContainer<Place> _searchContainer;
