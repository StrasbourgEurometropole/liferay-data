...
public class CommentPersistenceImpl
	...
	public List<Comment> findByAssetEntryIdAndLevel(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			pagination = false;
			finderPath = _finderPathWithoutPaginationFindByAssetEntryIdAndLevel;
