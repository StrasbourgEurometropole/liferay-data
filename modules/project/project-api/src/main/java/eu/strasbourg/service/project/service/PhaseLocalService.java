...
/**
 * Provides the local service interface for Phase. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Cedric Henry
 * @see PhaseLocalServiceUtil
...
public interface PhaseLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PhaseLocalServiceUtil} to access the phase local service. Add custom service methods to {@link eu.strasbourg.service.project.service.impl.PhaseLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public Phase createPhase(long PhaseId);
	...
	*/
	...
	public Phase deletePhase(Phase phase);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Phase deletePhase(long PhaseId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Phase fetchPhase(long PhaseId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Phase fetchPhaseByUuidAndGroupId(java.lang.String uuid, long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Phase getPhase(long PhaseId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Phase getPhaseByUuidAndGroupId(java.lang.String uuid, long groupId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Phase> getPhases(int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Phase> getPhasesByUuidAndCompanyId(java.lang.String uuid,
		long companyId);
