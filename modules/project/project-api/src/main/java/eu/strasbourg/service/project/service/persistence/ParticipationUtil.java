...
public class ParticipationUtil {
	...
	private static ServiceTracker
		<ParticipationPersistence, ParticipationPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ParticipationPersistence.class);

		ServiceTracker<ParticipationPersistence, ParticipationPersistence>
			serviceTracker =
				new ServiceTracker
					<ParticipationPersistence, ParticipationPersistence>(
						bundle.getBundleContext(),
						ParticipationPersistence.class, null);
