...
public class InitiativeLocalServiceWrapper implements InitiativeLocalService,
	...
	*/
	...
	@Override
	public java.util.List<eu.strasbourg.service.project.model.Initiative> findHelpedByPublikUserId(
		java.lang.String publikUserId) {
	...
	*/
	...
	@Override
	public java.util.List<eu.strasbourg.service.project.model.Initiative> getByPublikUserID(
