...
public class BudgetPhaseUtil {
	...
	private static ServiceTracker
		<BudgetPhasePersistence, BudgetPhasePersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(BudgetPhasePersistence.class);

		ServiceTracker<BudgetPhasePersistence, BudgetPhasePersistence>
			serviceTracker =
				new ServiceTracker
					<BudgetPhasePersistence, BudgetPhasePersistence>(
						bundle.getBundleContext(), BudgetPhasePersistence.class,
						null);
