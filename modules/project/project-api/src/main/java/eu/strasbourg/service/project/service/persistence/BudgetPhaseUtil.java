...
public class BudgetPhaseUtil {
	...
	* @return the matching budget phases
	*/
	public static List<BudgetPhase> findByIsActiveAndGroupId(boolean isActive,
		long groupId) {
	...
	*/
	public static List<BudgetPhase> findByIsActiveAndGroupId(boolean isActive,
		...
		return getPersistence()
				   .findByIsActiveAndGroupId(isActive, groupId, start, end);
	}
	...
	* @throws NoSuchBudgetPhaseException if a matching budget phase could not be found
	*/
	public static BudgetPhase findByIsActiveAndGroupId_First(boolean isActive,
		long groupId, OrderByComparator<BudgetPhase> orderByComparator)
		throws eu.strasbourg.service.project.exception.NoSuchBudgetPhaseException {
		return getPersistence()
				   .findByIsActiveAndGroupId_First(isActive, groupId,
			orderByComparator);
	}
	...
	*/
	public static BudgetPhase fetchByIsActiveAndGroupId_First(
		...
		OrderByComparator<BudgetPhase> orderByComparator) {
		return getPersistence()
				   .fetchByIsActiveAndGroupId_First(isActive, groupId,
			orderByComparator);
	}
	...
	* @throws NoSuchBudgetPhaseException if a matching budget phase could not be found
	*/
	public static BudgetPhase findByIsActiveAndGroupId_Last(boolean isActive,
		long groupId, OrderByComparator<BudgetPhase> orderByComparator)
		throws eu.strasbourg.service.project.exception.NoSuchBudgetPhaseException {
		return getPersistence()
				   .findByIsActiveAndGroupId_Last(isActive, groupId,
			orderByComparator);
	}
	...
	* @return the last matching budget phase, or <code>null</code> if a matching budget phase could not be found
	*/
	public static BudgetPhase fetchByIsActiveAndGroupId_Last(boolean isActive,
		long groupId, OrderByComparator<BudgetPhase> orderByComparator) {
		return getPersistence()
				   .fetchByIsActiveAndGroupId_Last(isActive, groupId,
			orderByComparator);
	}
	...
	*/
	public static BudgetPhase[] findByIsActiveAndGroupId_PrevAndNext(
		...
		throws eu.strasbourg.service.project.exception.NoSuchBudgetPhaseException {
		return getPersistence()
				   .findByIsActiveAndGroupId_PrevAndNext(budgetPhaseId,
	...
	* @param groupId the group ID
	*/
	public static void removeByIsActiveAndGroupId(boolean isActive, long groupId) {
	...
	* @return the number of matching budget phases
	*/
	public static int countByIsActiveAndGroupId(boolean isActive, long groupId) {
