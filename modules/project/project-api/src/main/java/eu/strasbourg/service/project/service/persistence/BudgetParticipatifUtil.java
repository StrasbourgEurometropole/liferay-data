...
public class BudgetParticipatifUtil {
	...
	* @throws NoSuchBudgetParticipatifException if a matching budget participatif could not be found
	*/
	public static BudgetParticipatif findByParentId_First(long parentId,
		OrderByComparator<BudgetParticipatif> orderByComparator)
		throws eu.strasbourg.service.project.exception.NoSuchBudgetParticipatifException {
	...
	* @return the first matching budget participatif, or <code>null</code> if a matching budget participatif could not be found
	*/
	public static BudgetParticipatif fetchByParentId_First(long parentId,
		OrderByComparator<BudgetParticipatif> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchBudgetParticipatifException if a matching budget participatif could not be found
	*/
	public static BudgetParticipatif findByParentId_Last(long parentId,
		OrderByComparator<BudgetParticipatif> orderByComparator)
		throws eu.strasbourg.service.project.exception.NoSuchBudgetParticipatifException {
	...
	* @return the last matching budget participatif, or <code>null</code> if a matching budget participatif could not be found
	*/
	public static BudgetParticipatif fetchByParentId_Last(long parentId,
		OrderByComparator<BudgetParticipatif> orderByComparator) {
	...
	*/
	public static BudgetParticipatif[] findByParentId_PrevAndNext(
		...
		throws eu.strasbourg.service.project.exception.NoSuchBudgetParticipatifException {
		return getPersistence()
				   .findByParentId_PrevAndNext(budgetParticipatifId, parentId,
			orderByComparator);
	}
	...
	*/
	public static List<BudgetParticipatif> findByisCrushAndPublished(
		...
		return getPersistence()
				   .findByisCrushAndPublished(isCrush, status, groupId);
	}
	...
	*/
	public static List<BudgetParticipatif> findByisCrushAndPublished(
		...
		return getPersistence()
				   .findByisCrushAndPublished(isCrush, status, groupId, start,
			end);
	}
	...
	*/
	public static BudgetParticipatif findByisCrushAndPublished_First(
		...
		throws eu.strasbourg.service.project.exception.NoSuchBudgetParticipatifException {
		return getPersistence()
				   .findByisCrushAndPublished_First(isCrush, status, groupId,
			orderByComparator);
	}
	...
	*/
	public static BudgetParticipatif fetchByisCrushAndPublished_First(
		...
		OrderByComparator<BudgetParticipatif> orderByComparator) {
		return getPersistence()
				   .fetchByisCrushAndPublished_First(isCrush, status, groupId,
			orderByComparator);
	}
	...
	*/
	public static BudgetParticipatif findByisCrushAndPublished_Last(
		...
		throws eu.strasbourg.service.project.exception.NoSuchBudgetParticipatifException {
		return getPersistence()
				   .findByisCrushAndPublished_Last(isCrush, status, groupId,
			orderByComparator);
	}
	...
	*/
	public static BudgetParticipatif fetchByisCrushAndPublished_Last(
		...
		OrderByComparator<BudgetParticipatif> orderByComparator) {
		return getPersistence()
				   .fetchByisCrushAndPublished_Last(isCrush, status, groupId,
			orderByComparator);
	}
	...
	*/
	public static BudgetParticipatif[] findByisCrushAndPublished_PrevAndNext(
		...
		throws eu.strasbourg.service.project.exception.NoSuchBudgetParticipatifException {
		return getPersistence()
				   .findByisCrushAndPublished_PrevAndNext(budgetParticipatifId,
	...
	* @param groupId the group ID
	*/
	public static void removeByisCrushAndPublished(boolean isCrush, int status,
		long groupId) {
	...
	* @return the number of matching budget participatifs
	*/
	public static int countByisCrushAndPublished(boolean isCrush, int status,
		long groupId) {
		return getPersistence()
				   .countByisCrushAndPublished(isCrush, status, groupId);
	}
