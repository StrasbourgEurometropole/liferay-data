...
public class ProjectFollowedUtil {
	...
	public static ProjectFollowed fetchByPublikUserIdAndProjectId(
		...
		return getPersistence().fetchByPublikUserIdAndProjectId(
			publikUserId, projectId, retrieveFromCache);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			ProjectFollowedPersistence.class);

		ServiceTracker<ProjectFollowedPersistence, ProjectFollowedPersistence>
			serviceTracker =
				new ServiceTracker
					<ProjectFollowedPersistence, ProjectFollowedPersistence>(
						bundle.getBundleContext(),
						ProjectFollowedPersistence.class, null);
