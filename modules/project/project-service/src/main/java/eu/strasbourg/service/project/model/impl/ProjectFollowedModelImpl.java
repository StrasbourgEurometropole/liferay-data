	...
	static {
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<ProjectFollowed, Object>() {
				...
				@Override
				public void accept(
					ProjectFollowed projectFollowed, Object projectFollowedId) {
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<ProjectFollowed, Object>() {
				...
				@Override
				public void accept(
					ProjectFollowed projectFollowed, Object createDate) {

					projectFollowed.setCreateDate((Date)createDate);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<ProjectFollowed, Object>() {
				...
				@Override
				public void accept(
					ProjectFollowed projectFollowed, Object publikUserId) {

					projectFollowed.setPublikUserId((String)publikUserId);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<ProjectFollowed, Object>() {
				...
				@Override
				public void accept(
					ProjectFollowed projectFollowed, Object projectId) {

					projectFollowed.setProjectId((Long)projectId);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<ProjectFollowed, Object>() {
				...
				@Override
				public void accept(
					ProjectFollowed projectFollowed, Object groupId) {

					projectFollowed.setGroupId((Long)groupId);
				}
