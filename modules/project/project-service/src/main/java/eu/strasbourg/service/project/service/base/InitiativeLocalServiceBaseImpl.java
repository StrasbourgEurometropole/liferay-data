...
public abstract class InitiativeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements InitiativeLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link eu.strasbourg.service.project.service.InitiativeLocalServiceUtil} to access the initiative local service.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Initiative.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return initiativePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	 ...
	 */
	@Override
	public Initiative fetchInitiativeByUuidAndGroupId(String uuid, long groupId) {
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(initiativeLocalService);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setAddCriteriaMethod(new ActionableDynamicQuery.AddCriteriaMethod() {
				...
				public void addCriteria(DynamicQuery dynamicQuery) {
					...
					if (portletDataContext.isInitialPublication()) {
						...
						StagedModelDataHandler<?> stagedModelDataHandler = StagedModelDataHandlerRegistryUtil.getStagedModelDataHandler(Initiative.class.getName());
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<Initiative>() {
				@Override
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return initiativeLocalService.deleteInitiative((Initiative)persistedModel);
	}
	 ...
	 */
	@Override
	public List<Initiative> getInitiativesByUuidAndCompanyId(String uuid,
		long companyId) {
	...
	public List<Initiative> getInitiativesByUuidAndCompanyId(String uuid,
		...
		return initiativePersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("eu.strasbourg.service.project.model.Initiative",
