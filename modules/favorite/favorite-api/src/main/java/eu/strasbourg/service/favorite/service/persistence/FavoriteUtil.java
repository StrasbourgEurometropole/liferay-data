...
public class FavoriteUtil {
	...
	* @return the matching favorites
	*/
	public static List<Favorite> findByEntityIdAndTypeId(long entityId,
		long typeId) {
	...
	* @throws NoSuchFavoriteException if a matching favorite could not be found
	*/
	public static Favorite findByEntityIdAndTypeId_First(long entityId,
	...
	* @return the first matching favorite, or <code>null</code> if a matching favorite could not be found
	*/
	public static Favorite fetchByEntityIdAndTypeId_First(long entityId,
		long typeId, OrderByComparator<Favorite> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchFavoriteException if a matching favorite could not be found
	*/
	public static Favorite findByEntityIdAndTypeId_Last(long entityId,
		long typeId, OrderByComparator<Favorite> orderByComparator)
		throws eu.strasbourg.service.favorite.exception.NoSuchFavoriteException {
		return getPersistence()
	...
	* @return the last matching favorite, or <code>null</code> if a matching favorite could not be found
	*/
	public static Favorite fetchByEntityIdAndTypeId_Last(long entityId,
		long typeId, OrderByComparator<Favorite> orderByComparator) {
		return getPersistence()
	...
	*/
	public static Favorite[] findByEntityIdAndTypeId_PrevAndNext(
		...
		throws eu.strasbourg.service.favorite.exception.NoSuchFavoriteException {
		return getPersistence()
				   .findByEntityIdAndTypeId_PrevAndNext(favoriteId, entityId,
