...
<liferay-portlet:actionURL varImpl="searchActionURL" />
 ...
 <div class="container">
    <div class="row">
        <div class="col-md-8 pro-bloc-listing-initiative">
            <div id="breadcrumb">
        <span>
            ...
            <div class="row pro-wrapper-listing-initiative">
        ...
        <div class="col-md-4 pro-wrapper-aside">
            <div class="pro-bloc-facette pro-bloc-facette-initiative">
				...
				<aui:form action="${searchActionURL}" method="get" name="fm"
					...
					<liferay-util:include page="/forms/placit-initiatives-form.jsp"
        ...
        <div class="row">
            <div class="col-sm-6 col-xs-4 pull-left">
                ...
                <p class="hidden-xs">
                	...
                	<liferay-ui:message key="eu.among" /> ${dc.pager.count} <liferay-ui:message key="eu.initiative-minus-global" />
                </p>
            </div>
