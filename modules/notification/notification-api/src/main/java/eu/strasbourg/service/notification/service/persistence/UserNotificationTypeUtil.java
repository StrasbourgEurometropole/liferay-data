...
public class UserNotificationTypeUtil {
	...
	public static List<UserNotificationType> findByTypeId(
		...
		return getPersistence().findByTypeId(
			typeId, start, end, orderByComparator, retrieveFromCache);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			UserNotificationTypePersistence.class);

		ServiceTracker
			<UserNotificationTypePersistence, UserNotificationTypePersistence>
				serviceTracker =
					new ServiceTracker
						<UserNotificationTypePersistence,
						 UserNotificationTypePersistence>(
							 bundle.getBundleContext(),
							 UserNotificationTypePersistence.class, null);
