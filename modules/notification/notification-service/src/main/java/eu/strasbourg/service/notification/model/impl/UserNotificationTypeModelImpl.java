	...
	static {
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<UserNotificationType, Object>() {
				...
				public void accept(
					...
					userNotificationType.setPublikUserId((String)publikUserId);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<UserNotificationType, Object>() {
				...
				@Override
				public void accept(
					UserNotificationType userNotificationType, Object typeId) {

					userNotificationType.setTypeId((Long)typeId);
				}
