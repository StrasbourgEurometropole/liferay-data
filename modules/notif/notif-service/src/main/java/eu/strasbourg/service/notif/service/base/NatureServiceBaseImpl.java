...
import eu.strasbourg.service.notif.service.NatureService;
...
/**
 * Provides the base implementation for the nature remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.strasbourg.service.notif.service.impl.NatureServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see eu.strasbourg.service.notif.service.impl.NatureServiceImpl
 * @generated
 */
public abstract class NatureServiceBaseImpl
	extends BaseServiceImpl implements NatureService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NatureService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>eu.strasbourg.service.notif.service.NatureServiceUtil</code>.
	 */
	 ...
	 */
	public eu.strasbourg.service.notif.service.NatureLocalService
		getNatureLocalService() {
	 ...
	 */
	public void setNatureLocalService(
		eu.strasbourg.service.notif.service.NatureLocalService
			natureLocalService) {
	...
	/**
	 * Returns the nature remote service.
	 *
	 * @return the nature remote service
	 */
	...
	/**
	 * Sets the nature remote service.
	 *
	 * @param natureService the nature remote service
	 */
	...
	public String getOSGiServiceIdentifier() {
		return NatureService.class.getName();
	}
	...
	@BeanReference(
		type = eu.strasbourg.service.notif.service.NatureLocalService.class
	)
	protected eu.strasbourg.service.notif.service.NatureLocalService
		natureLocalService;

	@BeanReference(type = NatureService.class)
