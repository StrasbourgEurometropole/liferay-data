...
public class WSConstants {
    ...
    public static final String JSON_WC_TYPE_ARTICLE = "typeArticle";
    public static final String JSON_CATEGORIES = "categories";
    public static final String JSON_WC_TAGS = "tags";
    public static final String JSON_WC_HTML = "html";
    public static final String JSON_WC_THUMBNAIL_IMAGE = "thumbnailImage";
    public static final String JSON_WC_HEADER_IMAGE = "headerImage";
    public static final String JSON_WC_FEATURED_ARTICLES = "featuredArticles";
    public static final String JSON_WC_LANGUAGE = "language";
    public static final String JSON_WC_DATE_PUBLISHED = "datePublished";
    public static final String JSON_WC_NEWS_HEADLINE = "newsHeadline";
    public static final String JSON_WC_DESCRIPTION = "description";
