...
/**
 * The persistence utility for the form send record field service. This utility wraps {@link eu.strasbourg.service.formSendRecordField.service.persistence.impl.FormSendRecordFieldPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class FormSendRecordFieldUtil {
	 ...
	 */
	public static FormSendRecordField update(
		FormSendRecordField formSendRecordField, ServiceContext serviceContext) {
	...
	*/
	public static List<FormSendRecordField> findByUuid(java.lang.String uuid) {
	...
	*/
	public static FormSendRecordField findByUuid_First(java.lang.String uuid,
		OrderByComparator<FormSendRecordField> orderByComparator)
	...
	*/
	public static FormSendRecordField fetchByUuid_First(java.lang.String uuid,
		OrderByComparator<FormSendRecordField> orderByComparator) {
	...
	* @throws NoSuchFormSendRecordFieldException if a matching form send record field could not be found
	*/
	public static FormSendRecordField findByUuid_Last(java.lang.String uuid,
		OrderByComparator<FormSendRecordField> orderByComparator)
		throws eu.strasbourg.service.formSendRecordField.exception.NoSuchFormSendRecordFieldException {
	...
	*/
	public static FormSendRecordField fetchByUuid_Last(java.lang.String uuid,
		OrderByComparator<FormSendRecordField> orderByComparator) {
	...
	*/
	public static FormSendRecordField[] findByUuid_PrevAndNext(
		...
		throws eu.strasbourg.service.formSendRecordField.exception.NoSuchFormSendRecordFieldException {
		return getPersistence()
				   .findByUuid_PrevAndNext(formSendRecordFieldId, uuid,
			orderByComparator);
	}
	...
	* @throws NoSuchFormSendRecordFieldException if a matching form send record field could not be found
	*/
	public static FormSendRecordField findByUUID_G(java.lang.String uuid,
		long groupId)
		throws eu.strasbourg.service.formSendRecordField.exception.NoSuchFormSendRecordFieldException {
	...
	*/
	public static FormSendRecordField fetchByUUID_G(java.lang.String uuid,
		long groupId) {
	...
	*/
	public static FormSendRecordField removeByUUID_G(java.lang.String uuid,
		long groupId)
		throws eu.strasbourg.service.formSendRecordField.exception.NoSuchFormSendRecordFieldException {
	...
	* @throws NoSuchFormSendRecordFieldException if a matching form send record field could not be found
	*/
	public static FormSendRecordField findByUuid_C_Last(java.lang.String uuid,
		long companyId, OrderByComparator<FormSendRecordField> orderByComparator)
		throws eu.strasbourg.service.formSendRecordField.exception.NoSuchFormSendRecordFieldException {
		return getPersistence()
	...
	*/
	public static FormSendRecordField[] findByUuid_C_PrevAndNext(
		...
		throws eu.strasbourg.service.formSendRecordField.exception.NoSuchFormSendRecordFieldException {
		return getPersistence()
				   .findByUuid_C_PrevAndNext(formSendRecordFieldId, uuid,
	...
	* @throws NoSuchFormSendRecordFieldException if a matching form send record field could not be found
	*/
	public static FormSendRecordField findByGroupId_First(long groupId,
		OrderByComparator<FormSendRecordField> orderByComparator)
		throws eu.strasbourg.service.formSendRecordField.exception.NoSuchFormSendRecordFieldException {
	...
	* @return the first matching form send record field, or <code>null</code> if a matching form send record field could not be found
	*/
	public static FormSendRecordField fetchByGroupId_First(long groupId,
		OrderByComparator<FormSendRecordField> orderByComparator) {
	...
	* @throws NoSuchFormSendRecordFieldException if a matching form send record field could not be found
	*/
	public static FormSendRecordField findByGroupId_Last(long groupId,
		OrderByComparator<FormSendRecordField> orderByComparator)
		throws eu.strasbourg.service.formSendRecordField.exception.NoSuchFormSendRecordFieldException {
	...
	* @return the last matching form send record field, or <code>null</code> if a matching form send record field could not be found
	*/
	public static FormSendRecordField fetchByGroupId_Last(long groupId,
		OrderByComparator<FormSendRecordField> orderByComparator) {
	...
	*/
	public static FormSendRecordField[] findByGroupId_PrevAndNext(
		...
		throws eu.strasbourg.service.formSendRecordField.exception.NoSuchFormSendRecordFieldException {
		return getPersistence()
				   .findByGroupId_PrevAndNext(formSendRecordFieldId, groupId,
			orderByComparator);
	}
	...
	*/
	public static FormSendRecordField[] findByAssetEntryId_PrevAndNext(
		...
		throws eu.strasbourg.service.formSendRecordField.exception.NoSuchFormSendRecordFieldException {
		return getPersistence()
				   .findByAssetEntryId_PrevAndNext(formSendRecordFieldId,
	...
	*/
	public static List<FormSendRecordField> findByContentAndInstanceId(
		...
		return getPersistence().findByContentAndInstanceId(contentId, instanceId);
	}
	...
	*/
	public static List<FormSendRecordField> findByContentAndInstanceId(
		...
		return getPersistence()
				   .findByContentAndInstanceId(contentId, instanceId, start, end);
	}
	...
	*/
	public static List<FormSendRecordField> findByContentAndInstanceId(
		...
		OrderByComparator<FormSendRecordField> orderByComparator) {
		return getPersistence()
				   .findByContentAndInstanceId(contentId, instanceId, start,
	...
	*/
	public static FormSendRecordField findByContentAndInstanceId_First(
		...
		throws eu.strasbourg.service.formSendRecordField.exception.NoSuchFormSendRecordFieldException {
		return getPersistence()
				   .findByContentAndInstanceId_First(contentId, instanceId,
			orderByComparator);
	}
	...
	*/
	public static FormSendRecordField fetchByContentAndInstanceId_First(
		...
		OrderByComparator<FormSendRecordField> orderByComparator) {
		return getPersistence()
				   .fetchByContentAndInstanceId_First(contentId, instanceId,
			orderByComparator);
	}
	...
	*/
	public static FormSendRecordField findByContentAndInstanceId_Last(
		...
		throws eu.strasbourg.service.formSendRecordField.exception.NoSuchFormSendRecordFieldException {
		return getPersistence()
				   .findByContentAndInstanceId_Last(contentId, instanceId,
			orderByComparator);
	}
	...
	*/
	public static FormSendRecordField fetchByContentAndInstanceId_Last(
		...
		OrderByComparator<FormSendRecordField> orderByComparator) {
		return getPersistence()
				   .fetchByContentAndInstanceId_Last(contentId, instanceId,
			orderByComparator);
	}
	...
	*/
	public static FormSendRecordField[] findByContentAndInstanceId_PrevAndNext(
		...
		throws eu.strasbourg.service.formSendRecordField.exception.NoSuchFormSendRecordFieldException {
		return getPersistence()
				   .findByContentAndInstanceId_PrevAndNext(formSendRecordFieldId,
	...
	* @param instanceId the instance ID
	*/
	public static void removeByContentAndInstanceId(long contentId,
		java.lang.String instanceId) {
	...
	* @return the number of matching form send record fields
	*/
	public static int countByContentAndInstanceId(long contentId,
		java.lang.String instanceId) {
		return getPersistence()
				   .countByContentAndInstanceId(contentId, instanceId);
	}
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, FormSendRecordField> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<FormSendRecordFieldPersistence, FormSendRecordFieldPersistence> _serviceTracker =
		ServiceTrackerFactory.open(FormSendRecordFieldPersistence.class);
}