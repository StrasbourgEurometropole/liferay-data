...
public class ActivityItemSelectorView
	implements ItemSelectorView<ActivityItemSelectorCriterion> {
	...
	@Override
	public Class<ActivityItemSelectorCriterion> getItemSelectorCriterionClass() {
	...
	public void renderHTML(ServletRequest servletRequest,
		...
		ActivityItemSelectorCriterion itemSelectorCriterion,
		...
		List<Activity> activities = ActivityLocalServiceUtil.findByKeyword(keywords,
			themeDisplay.getScopeGroupId(), (delta * cur) - delta,
			((delta * cur) + delta));

		long activitiesCount = ActivityLocalServiceUtil.findByKeywordCount(
		...
		RequestDispatcher requestDispatcher = servletContext
			.getRequestDispatcher(
				"/activity/item-selector/activity-item-selector.jsp");
