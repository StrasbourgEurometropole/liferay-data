...
public class ImportReportLineUtil {
	...
	public static List<ImportReportLine> findByTypeAndStatus(
		...
		return getPersistence().findByTypeAndStatus(
			type, status, start, end, orderByComparator, retrieveFromCache);
	}
	...
	public static List<ImportReportLine> findByReportId(
		...
		return getPersistence().findByReportId(
			reportId, start, end, orderByComparator, retrieveFromCache);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			ImportReportLinePersistence.class);

		ServiceTracker<ImportReportLinePersistence, ImportReportLinePersistence>
			serviceTracker =
				new ServiceTracker
					<ImportReportLinePersistence, ImportReportLinePersistence>(
						bundle.getBundleContext(),
						ImportReportLinePersistence.class, null);
