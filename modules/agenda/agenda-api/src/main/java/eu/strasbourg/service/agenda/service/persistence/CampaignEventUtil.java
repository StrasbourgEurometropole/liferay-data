...
public class CampaignEventUtil {
	...
	public static List<CampaignEvent> findByCampaignId(
		...
		return getPersistence().findByCampaignId(
			campaignId, start, end, orderByComparator, retrieveFromCache);
	}
	...
	private static ServiceTracker
		<CampaignEventPersistence, CampaignEventPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CampaignEventPersistence.class);

		ServiceTracker<CampaignEventPersistence, CampaignEventPersistence>
			serviceTracker =
				new ServiceTracker
					<CampaignEventPersistence, CampaignEventPersistence>(
						bundle.getBundleContext(),
						CampaignEventPersistence.class, null);
