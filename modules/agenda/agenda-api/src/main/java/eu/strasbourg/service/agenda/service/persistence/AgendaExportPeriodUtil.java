...
public class AgendaExportPeriodUtil {
	...
	public static List<AgendaExportPeriod> findByAgendaExportId(
		...
		return getPersistence().findByAgendaExportId(
			agendaExportId, start, end, orderByComparator, retrieveFromCache);
	}
