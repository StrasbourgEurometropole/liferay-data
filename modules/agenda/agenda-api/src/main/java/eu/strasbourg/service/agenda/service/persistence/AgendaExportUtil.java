...
public class AgendaExportUtil {
	...
	private static ServiceTracker
		<AgendaExportPersistence, AgendaExportPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(AgendaExportPersistence.class);

		ServiceTracker<AgendaExportPersistence, AgendaExportPersistence>
			serviceTracker =
				new ServiceTracker
					<AgendaExportPersistence, AgendaExportPersistence>(
						bundle.getBundleContext(),
						AgendaExportPersistence.class, null);
