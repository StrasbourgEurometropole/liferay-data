...
public class EventPeriodUtil {
	...
	public static List<EventPeriod> findByCampaignEventId(
		...
		return getPersistence().findByCampaignEventId(
			campaignEventId, start, end, orderByComparator, retrieveFromCache);
	}
	...
	private static ServiceTracker
		<EventPeriodPersistence, EventPeriodPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(EventPeriodPersistence.class);

		ServiceTracker<EventPeriodPersistence, EventPeriodPersistence>
			serviceTracker =
				new ServiceTracker
					<EventPeriodPersistence, EventPeriodPersistence>(
						bundle.getBundleContext(), EventPeriodPersistence.class,
						null);
