...
public class ImportReportUtil {
	...
	private static ServiceTracker
		<ImportReportPersistence, ImportReportPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ImportReportPersistence.class);

		ServiceTracker<ImportReportPersistence, ImportReportPersistence>
			serviceTracker =
				new ServiceTracker
					<ImportReportPersistence, ImportReportPersistence>(
						bundle.getBundleContext(),
						ImportReportPersistence.class, null);
