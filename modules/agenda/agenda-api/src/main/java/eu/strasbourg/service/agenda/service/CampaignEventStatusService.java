...
public interface CampaignEventStatusService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CampaignEventStatusServiceUtil} to access the campaign event status remote service. Add custom service methods to <code>eu.strasbourg.service.agenda.service.impl.CampaignEventStatusServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
