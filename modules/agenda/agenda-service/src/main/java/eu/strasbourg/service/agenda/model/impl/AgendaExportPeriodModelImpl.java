	...
	static {
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<AgendaExportPeriod, Object>() {
				...
				@Override
				public void accept(
					AgendaExportPeriod agendaExportPeriod, Object uuid) {

					agendaExportPeriod.setUuid((String)uuid);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<AgendaExportPeriod, Object>() {
				...
				@Override
				public void accept(
					AgendaExportPeriod agendaExportPeriod, Object startDate) {

					agendaExportPeriod.setStartDate((Date)startDate);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<AgendaExportPeriod, Object>() {
				...
				@Override
				public void accept(
					AgendaExportPeriod agendaExportPeriod, Object endDate) {

					agendaExportPeriod.setEndDate((Date)endDate);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<AgendaExportPeriod, Object>() {
				...
				public void accept(
					AgendaExportPeriod agendaExportPeriod,
					Object agendaExportId) {

					agendaExportPeriod.setAgendaExportId((Long)agendaExportId);
				}
