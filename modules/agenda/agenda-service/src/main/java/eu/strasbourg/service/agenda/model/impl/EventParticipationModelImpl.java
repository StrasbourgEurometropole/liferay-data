	...
	static {
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<EventParticipation, Object>() {
				...
				@Override
				public void accept(
					EventParticipation eventParticipation, Object createDate) {

					eventParticipation.setCreateDate((Date)createDate);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<EventParticipation, Object>() {
				...
				public void accept(
					...
					eventParticipation.setPublikUserId((String)publikUserId);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<EventParticipation, Object>() {
				...
				@Override
				public void accept(
					EventParticipation eventParticipation, Object eventId) {

					eventParticipation.setEventId((Long)eventId);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<EventParticipation, Object>() {
				...
				@Override
				public void accept(
					EventParticipation eventParticipation, Object groupId) {

					eventParticipation.setGroupId((Long)groupId);
				}
