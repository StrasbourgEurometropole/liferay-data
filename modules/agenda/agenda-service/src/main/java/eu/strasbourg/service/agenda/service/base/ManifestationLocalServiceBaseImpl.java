...
public abstract class ManifestationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ManifestationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link eu.strasbourg.service.agenda.service.ManifestationLocalServiceUtil} to access the manifestation local service.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Manifestation.class,
	 ...
	 */
	@Override
	public Manifestation fetchManifestationByUuidAndGroupId(String uuid,
		long groupId) {
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(manifestationLocalService);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setAddCriteriaMethod(new ActionableDynamicQuery.AddCriteriaMethod() {
				...
				public void addCriteria(DynamicQuery dynamicQuery) {
					...
					if (portletDataContext.isInitialPublication()) {
						...
						StagedModelDataHandler<?> stagedModelDataHandler = StagedModelDataHandlerRegistryUtil.getStagedModelDataHandler(Manifestation.class.getName());
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<Manifestation>() {
				@Override
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return manifestationLocalService.deleteManifestation((Manifestation)persistedModel);
	}
	...
	public List<Manifestation> getManifestationsByUuidAndCompanyId(
		...
		return manifestationPersistence.findByUuid_C(uuid, companyId, start,
	 ...
	 */
	@Override
	public Manifestation getManifestationByUuidAndGroupId(String uuid,
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("eu.strasbourg.service.agenda.model.Manifestation",
