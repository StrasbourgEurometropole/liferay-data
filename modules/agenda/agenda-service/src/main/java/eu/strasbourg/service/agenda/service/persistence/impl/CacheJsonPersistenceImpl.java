...
public class CacheJsonPersistenceImpl
	...
	public CacheJson fetchByeventId(long eventId, boolean retrieveFromCache) {
		...
		if (result == null) {
			...
			try {
				...
				finderCache.removeResult(_finderPathFetchByeventId, finderArgs);
	...
	public CacheJson fetchByeventIdAndIsApproved(
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_EVENTIDANDISAPPROVED_EVENTID_2);

			query.append(_FINDER_COLUMN_EVENTIDANDISAPPROVED_ISAPPROVED_2);
	...
	public List<CacheJson> findByisApproved(
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_ISAPPROVED_ISAPPROVED_2);
