	...
	static {
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<CampaignEventStatus, Object>() {
				...
				@Override
				public void accept(
					CampaignEventStatus campaignEventStatus, Object uuid) {

					campaignEventStatus.setUuid((String)uuid);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<CampaignEventStatus, Object>() {
				...
				@Override
				public void accept(
					CampaignEventStatus campaignEventStatus, Object statusId) {

					campaignEventStatus.setStatusId((Long)statusId);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<CampaignEventStatus, Object>() {
				...
				@Override
				public void accept(
					CampaignEventStatus campaignEventStatus, Object status) {

					campaignEventStatus.setStatus((Integer)status);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<CampaignEventStatus, Object>() {
				...
				@Override
				public void accept(
					CampaignEventStatus campaignEventStatus, Object comment) {

					campaignEventStatus.setComment((String)comment);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<CampaignEventStatus, Object>() {
				...
				public void accept(
					...
					Object deletionDenied) {

					campaignEventStatus.setDeletionDenied(
						(Boolean)deletionDenied);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<CampaignEventStatus, Object>() {
				...
				@Override
				public void accept(
					CampaignEventStatus campaignEventStatus, Object date) {

					campaignEventStatus.setDate((Date)date);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<CampaignEventStatus, Object>() {
				...
				@Override
				public void accept(
					CampaignEventStatus campaignEventStatus, Object userId) {

					campaignEventStatus.setUserId((Long)userId);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<CampaignEventStatus, Object>() {
				...
				@Override
				public void accept(
					CampaignEventStatus campaignEventStatus, Object userName) {

					campaignEventStatus.setUserName((String)userName);
				}
