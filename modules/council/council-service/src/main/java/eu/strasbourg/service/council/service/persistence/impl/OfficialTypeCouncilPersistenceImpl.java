...
public class OfficialTypeCouncilPersistenceImpl
	...
	public List<OfficialTypeCouncil> findByUuid(
		...
		if (list == null) {
			...
			query.append(_SQL_SELECT_OFFICIALTYPECOUNCIL_WHERE);
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			query.append(_SQL_COUNT_OFFICIALTYPECOUNCIL_WHERE);
	...
	public OfficialTypeCouncil fetchByTypeIdAndOfficialId(
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_TYPEIDANDOFFICIALID_TYPEID_2);

			query.append(_FINDER_COLUMN_TYPEIDANDOFFICIALID_OFFICIALID_2);
	...
	public OfficialTypeCouncil create(
		...
		officialTypeCouncil.setCompanyId(companyProvider.getCompanyId());
	...
	public OfficialTypeCouncil remove(Serializable primaryKey)
		...
		catch (NoSuchOfficialTypeCouncilException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_OFFICIALTYPECOUNCIL);
