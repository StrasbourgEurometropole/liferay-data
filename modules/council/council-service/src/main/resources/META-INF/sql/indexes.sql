...
create index IX_475D5B17 on council_Procuration (sessionId);
...
create index IX_42C2D263 on council_Session (sessionId);
create index IX_9AEB2B12 on council_Session (uuid_[$COLUMN_LENGTH:75$], companyId);
create unique index IX_F9074E14 on council_Session (uuid_[$COLUMN_LENGTH:75$], groupId);
