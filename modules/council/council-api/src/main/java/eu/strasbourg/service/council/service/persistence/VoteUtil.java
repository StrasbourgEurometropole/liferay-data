...
public class VoteUtil {
	...
	public static List<Vote> findByDeliberationId(
		...
		return getPersistence().findByDeliberationId(
			deliberationId, start, end, orderByComparator, retrieveFromCache);
	}
	...
	public static Vote fetchByDeliberationIdAndOfficialId(
		...
		return getPersistence().fetchByDeliberationIdAndOfficialId(
			deliberationId, officialId, retrieveFromCache);
	}
	...
	private static ServiceTracker<VotePersistence, VotePersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(VotePersistence.class);

		ServiceTracker<VotePersistence, VotePersistence> serviceTracker =
			new ServiceTracker<VotePersistence, VotePersistence>(
				bundle.getBundleContext(), VotePersistence.class, null);
