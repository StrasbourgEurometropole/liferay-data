...
public class ProcurationUtil {
	...
	public static List<Procuration> findByCouncilSessionId(
		...
		return getPersistence().findByCouncilSessionId(
			councilSessionId, start, end, orderByComparator, retrieveFromCache);
	}
	...
	private static ServiceTracker
		<ProcurationPersistence, ProcurationPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ProcurationPersistence.class);

		ServiceTracker<ProcurationPersistence, ProcurationPersistence>
			serviceTracker =
				new ServiceTracker
					<ProcurationPersistence, ProcurationPersistence>(
						bundle.getBundleContext(), ProcurationPersistence.class,
						null);
