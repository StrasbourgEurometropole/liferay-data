 ...
 * {@link eu.strasbourg.service.council.service.impl.VoteLocalServiceImpl} and is the
...
public class VoteLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link eu.strasbourg.service.council.service.impl.VoteLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static eu.strasbourg.service.council.model.Vote fetchVoteByUuidAndGroupId(
	...
	*/
	public static eu.strasbourg.service.council.model.Vote getVoteByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<eu.strasbourg.service.council.model.Vote> getVotes(
		int start, int end) {
	...
	*/
	public static java.util.List<eu.strasbourg.service.council.model.Vote> getVotesByUuidAndCompanyId(
	...
	*/
	public static java.util.List<eu.strasbourg.service.council.model.Vote> getVotesByUuidAndCompanyId(
		...
		return getService()
				   .getVotesByUuidAndCompanyId(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	*/
	...
	private static ServiceTracker<VoteLocalService, VoteLocalService> _serviceTracker =
		ServiceTrackerFactory.open(VoteLocalService.class);
}