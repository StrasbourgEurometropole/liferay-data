...
public class OfficialUtil {
	 ...
	 * @return the matching official, or <code>null</code> if a matching official could not be found
	 */
	public static Official fetchByEmail(
	...
	public static List<Official> findByGroupIdAndIsActiveAndIsMunicipal(
		...
		return getPersistence().findByGroupIdAndIsActiveAndIsMunicipal(
	...
	public static List<Official> findByGroupIdAndIsActiveAndIsMunicipal(
		...
		return getPersistence().findByGroupIdAndIsActiveAndIsMunicipal(
			groupId, isActive, isMunicipal, start, end);
	}
	...
	public static Official findByGroupIdAndIsActiveAndIsMunicipal_First(
		...
		return getPersistence().findByGroupIdAndIsActiveAndIsMunicipal_First(
	...
	public static Official fetchByGroupIdAndIsActiveAndIsMunicipal_First(
		...
		return getPersistence().fetchByGroupIdAndIsActiveAndIsMunicipal_First(
			groupId, isActive, isMunicipal, orderByComparator);
	}
	...
	public static Official findByGroupIdAndIsActiveAndIsMunicipal_Last(
		...
		return getPersistence().findByGroupIdAndIsActiveAndIsMunicipal_Last(
			groupId, isActive, isMunicipal, orderByComparator);
	}
	...
	public static Official fetchByGroupIdAndIsActiveAndIsMunicipal_Last(
		...
		return getPersistence().fetchByGroupIdAndIsActiveAndIsMunicipal_Last(
			groupId, isActive, isMunicipal, orderByComparator);
	}
	...
	public static Official[] findByGroupIdAndIsActiveAndIsMunicipal_PrevAndNext(
		...
		return getPersistence().
			findByGroupIdAndIsActiveAndIsMunicipal_PrevAndNext(
				officialId, groupId, isActive, isMunicipal, orderByComparator);
	}
	 ...
	 * @param isMunicipal the is municipal
	 */
	public static void removeByGroupIdAndIsActiveAndIsMunicipal(
		long groupId, boolean isActive, boolean isMunicipal) {

		getPersistence().removeByGroupIdAndIsActiveAndIsMunicipal(
			groupId, isActive, isMunicipal);
	}
	 ...
	 * @return the number of matching officials
	 */
	public static int countByGroupIdAndIsActiveAndIsMunicipal(
		long groupId, boolean isActive, boolean isMunicipal) {

		return getPersistence().countByGroupIdAndIsActiveAndIsMunicipal(
			groupId, isActive, isMunicipal);
	}
	...
	public static List<Official> findByGroupIdAndIsActiveAndIsEurometropolitan(
		...
		return getPersistence().findByGroupIdAndIsActiveAndIsEurometropolitan(
	...
	public static Official findByGroupIdAndIsActiveAndIsEurometropolitan_First(
		...
		return getPersistence().
			findByGroupIdAndIsActiveAndIsEurometropolitan_First(
	...
	public static Official findByGroupIdAndIsActiveAndIsEurometropolitan_Last(
		...
		return getPersistence().
			findByGroupIdAndIsActiveAndIsEurometropolitan_Last(
				groupId, isActive, isEurometropolitan, orderByComparator);
	}
	...
	public static Official fetchByGroupIdAndIsActiveAndIsEurometropolitan_Last(
		...
		return getPersistence().
			fetchByGroupIdAndIsActiveAndIsEurometropolitan_Last(
				groupId, isActive, isEurometropolitan, orderByComparator);
	}
	 ...
	 * @throws NoSuchOfficialException if a official with the primary key could not be found
	 */
	public static Official[]
			findByGroupIdAndIsActiveAndIsEurometropolitan_PrevAndNext(
				long officialId, long groupId, boolean isActive,
		...
		return getPersistence().
			findByGroupIdAndIsActiveAndIsEurometropolitan_PrevAndNext(
				officialId, groupId, isActive, isEurometropolitan,
				orderByComparator);
	}
	...
	public static void removeByGroupIdAndIsActiveAndIsEurometropolitan(
		...
		getPersistence().removeByGroupIdAndIsActiveAndIsEurometropolitan(
			groupId, isActive, isEurometropolitan);
	}
	...
	public static int countByGroupIdAndIsActiveAndIsEurometropolitan(
		...
		return getPersistence().countByGroupIdAndIsActiveAndIsEurometropolitan(
			groupId, isActive, isEurometropolitan);
	}
	...
	private static ServiceTracker<OfficialPersistence, OfficialPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(OfficialPersistence.class);

		ServiceTracker<OfficialPersistence, OfficialPersistence>
			serviceTracker =
				new ServiceTracker<OfficialPersistence, OfficialPersistence>(
					bundle.getBundleContext(), OfficialPersistence.class, null);
