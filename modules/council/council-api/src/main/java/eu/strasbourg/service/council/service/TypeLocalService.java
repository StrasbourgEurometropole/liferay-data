...
public interface TypeLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TypeLocalServiceUtil} to access the type local service. Add custom service methods to {@link eu.strasbourg.service.council.service.impl.TypeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public boolean isTitleAlreadyUsed(java.lang.String title, long typeId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Type fetchTypeByUuidAndGroupId(java.lang.String uuid, long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Type getTypeByUuidAndGroupId(java.lang.String uuid, long groupId)
		throws PortalException;
	...
	*/
	public Type updateType(Type type, ServiceContext sc)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Type> getTypesByUuidAndCompanyId(java.lang.String uuid,
		long companyId);
