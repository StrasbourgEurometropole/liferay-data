...
/**
 * The persistence utility for the official type council service. This utility wraps {@link eu.strasbourg.service.council.service.persistence.impl.OfficialTypeCouncilPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see eu.strasbourg.service.council.service.persistence.impl.OfficialTypeCouncilPersistenceImpl
 * @generated
 */
@ProviderType
public class OfficialTypeCouncilUtil {
	 ...
	 */
	public static OfficialTypeCouncil update(
		OfficialTypeCouncil officialTypeCouncil, ServiceContext serviceContext) {
	...
	*/
	public static List<OfficialTypeCouncil> findByUuid(java.lang.String uuid) {
	...
	*/
	public static OfficialTypeCouncil findByUuid_First(java.lang.String uuid,
		OrderByComparator<OfficialTypeCouncil> orderByComparator)
		throws eu.strasbourg.service.council.exception.NoSuchOfficialTypeCouncilException {
	...
	*/
	public static OfficialTypeCouncil fetchByUuid_First(java.lang.String uuid,
		OrderByComparator<OfficialTypeCouncil> orderByComparator) {
	...
	* @throws NoSuchOfficialTypeCouncilException if a matching official type council could not be found
	*/
	public static OfficialTypeCouncil findByUuid_Last(java.lang.String uuid,
		OrderByComparator<OfficialTypeCouncil> orderByComparator)
		throws eu.strasbourg.service.council.exception.NoSuchOfficialTypeCouncilException {
	...
	*/
	public static OfficialTypeCouncil fetchByUuid_Last(java.lang.String uuid,
		OrderByComparator<OfficialTypeCouncil> orderByComparator) {
	...
	*/
	public static OfficialTypeCouncil[] findByUuid_PrevAndNext(
		...
		throws eu.strasbourg.service.council.exception.NoSuchOfficialTypeCouncilException {
		return getPersistence()
				   .findByUuid_PrevAndNext(officialTypeCouncilPK, uuid,
			orderByComparator);
	}
	...
	* @throws NoSuchOfficialTypeCouncilException if a matching official type council could not be found
	*/
	public static OfficialTypeCouncil findByUUID_G(java.lang.String uuid,
		long groupId)
		throws eu.strasbourg.service.council.exception.NoSuchOfficialTypeCouncilException {
	...
	*/
	public static OfficialTypeCouncil fetchByUUID_G(java.lang.String uuid,
		long groupId) {
	...
	*/
	public static OfficialTypeCouncil removeByUUID_G(java.lang.String uuid,
		long groupId)
		throws eu.strasbourg.service.council.exception.NoSuchOfficialTypeCouncilException {
	...
	* @throws NoSuchOfficialTypeCouncilException if a matching official type council could not be found
	*/
	public static OfficialTypeCouncil findByUuid_C_Last(java.lang.String uuid,
	...
	*/
	public static OfficialTypeCouncil[] findByUuid_C_PrevAndNext(
		...
		throws eu.strasbourg.service.council.exception.NoSuchOfficialTypeCouncilException {
		return getPersistence()
				   .findByUuid_C_PrevAndNext(officialTypeCouncilPK, uuid,
	...
	*/
	public static List<OfficialTypeCouncil> findByOfficialId(long officialId,
		...
		OrderByComparator<OfficialTypeCouncil> orderByComparator) {
		return getPersistence()
				   .findByOfficialId(officialId, start, end, orderByComparator);
	}
	...
	* @throws NoSuchOfficialTypeCouncilException if a matching official type council could not be found
	*/
	public static OfficialTypeCouncil findByOfficialId_First(long officialId,
		OrderByComparator<OfficialTypeCouncil> orderByComparator)
		throws eu.strasbourg.service.council.exception.NoSuchOfficialTypeCouncilException {
		return getPersistence()
				   .findByOfficialId_First(officialId, orderByComparator);
	}
	...
	* @return the first matching official type council, or <code>null</code> if a matching official type council could not be found
	*/
	public static OfficialTypeCouncil fetchByOfficialId_First(long officialId,
		OrderByComparator<OfficialTypeCouncil> orderByComparator) {
		return getPersistence()
				   .fetchByOfficialId_First(officialId, orderByComparator);
	}
	...
	* @throws NoSuchOfficialTypeCouncilException if a matching official type council could not be found
	*/
	public static OfficialTypeCouncil findByOfficialId_Last(long officialId,
		OrderByComparator<OfficialTypeCouncil> orderByComparator)
		throws eu.strasbourg.service.council.exception.NoSuchOfficialTypeCouncilException {
		return getPersistence()
				   .findByOfficialId_Last(officialId, orderByComparator);
	}
	...
	* @return the last matching official type council, or <code>null</code> if a matching official type council could not be found
	*/
	public static OfficialTypeCouncil fetchByOfficialId_Last(long officialId,
		OrderByComparator<OfficialTypeCouncil> orderByComparator) {
		return getPersistence()
				   .fetchByOfficialId_Last(officialId, orderByComparator);
	}
	...
	*/
	public static OfficialTypeCouncil[] findByOfficialId_PrevAndNext(
		...
		throws eu.strasbourg.service.council.exception.NoSuchOfficialTypeCouncilException {
		return getPersistence()
				   .findByOfficialId_PrevAndNext(officialTypeCouncilPK,
	...
	* @throws NoSuchOfficialTypeCouncilException if a matching official type council could not be found
	*/
	public static OfficialTypeCouncil findByTypeId_First(long typeId,
		OrderByComparator<OfficialTypeCouncil> orderByComparator)
		throws eu.strasbourg.service.council.exception.NoSuchOfficialTypeCouncilException {
	...
	* @return the first matching official type council, or <code>null</code> if a matching official type council could not be found
	*/
	public static OfficialTypeCouncil fetchByTypeId_First(long typeId,
		OrderByComparator<OfficialTypeCouncil> orderByComparator) {
	...
	* @throws NoSuchOfficialTypeCouncilException if a matching official type council could not be found
	*/
	public static OfficialTypeCouncil findByTypeId_Last(long typeId,
		OrderByComparator<OfficialTypeCouncil> orderByComparator)
		throws eu.strasbourg.service.council.exception.NoSuchOfficialTypeCouncilException {
	...
	* @return the last matching official type council, or <code>null</code> if a matching official type council could not be found
	*/
	public static OfficialTypeCouncil fetchByTypeId_Last(long typeId,
		OrderByComparator<OfficialTypeCouncil> orderByComparator) {
	...
	*/
	public static OfficialTypeCouncil[] findByTypeId_PrevAndNext(
		...
		throws eu.strasbourg.service.council.exception.NoSuchOfficialTypeCouncilException {
		return getPersistence()
				   .findByTypeId_PrevAndNext(officialTypeCouncilPK, typeId,
			orderByComparator);
	}
	...
	* @throws NoSuchOfficialTypeCouncilException if a matching official type council could not be found
	*/
	public static OfficialTypeCouncil findByTypeIdAndOfficialId(long typeId,
		long officialId)
		throws eu.strasbourg.service.council.exception.NoSuchOfficialTypeCouncilException {
	...
	* @return the matching official type council, or <code>null</code> if a matching official type council could not be found
	*/
	public static OfficialTypeCouncil fetchByTypeIdAndOfficialId(long typeId,
		long officialId) {
	...
	*/
	public static OfficialTypeCouncil fetchByTypeIdAndOfficialId(long typeId,
		...
		return getPersistence()
				   .fetchByTypeIdAndOfficialId(typeId, officialId,
			retrieveFromCache);
	}
	...
	* @return the official type council that was removed
	*/
	public static OfficialTypeCouncil removeByTypeIdAndOfficialId(long typeId,
		long officialId)
		throws eu.strasbourg.service.council.exception.NoSuchOfficialTypeCouncilException {
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, OfficialTypeCouncil> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<OfficialTypeCouncilPersistence, OfficialTypeCouncilPersistence> _serviceTracker =
		ServiceTrackerFactory.open(OfficialTypeCouncilPersistence.class);
}