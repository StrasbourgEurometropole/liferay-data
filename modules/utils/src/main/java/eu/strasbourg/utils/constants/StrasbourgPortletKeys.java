...
public class StrasbourgPortletKeys {
	...
	public static final String PLACE_BO = "eu_strasbourg_portlet_agenda_PlaceBOPortlet";
	public static final String PLACE_WEB = "eu_strasbourg_portlet_agenda_PlacePortlet";
