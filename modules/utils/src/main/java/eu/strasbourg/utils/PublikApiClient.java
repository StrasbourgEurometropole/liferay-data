...
public class PublikApiClient {
	 ...
	 * @param userPublikId Identifiant Publik de l'utilisateur
	 * @param includeDrafts true pour inclure les formulaires "brouillon" de l'utilisateur
	 * @return
	 */
	 ...
	 * @param endpoint Endpoint à appeler (doit commencer par "/")
	 * @param queryString Query string contenant les paramètres à passer au endpoint
	 * @return L'URL signée (via un paramètre "signature" dans la query string) à appeler
	 */
