...
public class FoundObjectUtil {
	...
	public static List<FoundObject> findByCategoryCode(
		...
		return getPersistence().findByCategoryCode(
			categoryCode, start, end, orderByComparator, retrieveFromCache);
	}
	...
	private static ServiceTracker
		<FoundObjectPersistence, FoundObjectPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(FoundObjectPersistence.class);

		ServiceTracker<FoundObjectPersistence, FoundObjectPersistence>
			serviceTracker =
				new ServiceTracker
					<FoundObjectPersistence, FoundObjectPersistence>(
						bundle.getBundleContext(), FoundObjectPersistence.class,
						null);
