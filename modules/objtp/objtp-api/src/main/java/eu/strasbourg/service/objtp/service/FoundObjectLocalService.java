...
public interface FoundObjectLocalService extends BaseLocalService,
	...
	*/
	public FoundObject createFoundObject(java.lang.String number);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public FoundObject deleteFoundObject(java.lang.String number)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FoundObject fetchFoundObject(java.lang.String number);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FoundObject getFoundObject(java.lang.String number)
		throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FoundObject> getFoundObjectByCategoryCode(
