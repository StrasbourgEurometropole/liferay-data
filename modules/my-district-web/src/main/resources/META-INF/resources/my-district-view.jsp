		        	...
		        	mega_source.push([
			        	<c:forEach var="curEntry" items="${dc.events}" varStatus="loopStatus">
							<c:set var="event" value="${curEntry.getAssetRenderer().getEvent()}"/>
			              {
			                ...
			                link: '${homeStrasbourgURL}evenement/-/entity/id/${event.eventId}/${dc.getNormalizedForURL(event.getTitle(locale))}',
								...
								<div class="flexbox">
									<div class="container-left">
										...
										<a href="#" class="add-favorites"
										   ...
										   data-url="${themeDisplay.getPortalURL()}${homeStrasbourgURL}lieu/-/entity/sig/${territoryDirection.getSIGid()}/${dc.getNormalizedForURL(territoryDirection.getAlias(locale))}"
										   data-id="${territoryDirection.placeId}">
											<span><liferay-ui:message key="eu.add-to-favorite" /></span>
										</a>
									</div>
								</div>
								<a href="${homeStrasbourgURL}lieu/-/entity/sig/${territoryDirection.SIGid}/${dc.getNormalizedForURL(territoryDirection.getAlias(locale))}" class="btn-square--bordered--core" title="${territoryDirection.getAlias(locale)}">
										<span class="flexbox">
		...
		<c:if test="${not empty townHall}">
			<div class="wi-wrapper">
				<section id="mairie">
					...
					<div class="flexbox">
						<div class="container-left">
							...
							<a href="#" class="add-favorites"
							   ...
							   data-url="${homeStrasbourgURL}lieu/-/entity/sig/${townHall.getSIGid()}/${dc.getNormalizedForURL(townHall.getAlias(locale))}"
					...
					<a href="${homeStrasbourgURL}lieu/-/entity/sig/${townHall.SIGid}/${dc.getNormalizedForURL(townHall.getAlias(locale))}" class="btn-square--bordered--core" title="${townHall.getAlias(locale)}">
							<span class="flexbox">
								<span class="btn-text"><liferay-ui:message key="detailed-card" /></span>
								<span class="btn-arrow"></span>
							</span>
                                ...
                                <c:forEach items="${sectorSchools}" var="school">
                                    <div class="ecoles-teaser">
                                        ...
                                        <a href="#" class="add-favorites"
                                           ...
                                           data-url="${homeStrasbourgURL}lieu/-/entity/sig/${school.getSIGid()}/${dc.getNormalizedForURL(school.getAlias(locale))}"
                                           data-id="${school.placeId}">
                                            <span><liferay-ui:message key="eu.add-to-favorite" /></span>
                                        </a>
                                        <a href="${homeStrasbourgURL}lieu/-/entity/sig/${school.SIGid}/${dc.getNormalizedForURL(school.getAlias(locale))}" class="btn-square--bordered--core" title="${school.getAlias(locale)}">
                                                <span class="flexbox">
                                                    <span class="btn-text"><liferay-ui:message key="detailed-card" /></span>
                                                    <span class="btn-arrow"></span>
                                                </span>
