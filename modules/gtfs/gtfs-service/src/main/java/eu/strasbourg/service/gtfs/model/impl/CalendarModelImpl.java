	...
	static {
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<Calendar, Object>() {
				...
				@Override
				public void accept(Calendar calendar, Object id) {
					calendar.setId((Long)id);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<Calendar, Object>() {
				...
				@Override
				public void accept(Calendar calendar, Object start_date) {
					calendar.setStart_date((Date)start_date);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<Calendar, Object>() {
				...
				@Override
				public void accept(Calendar calendar, Object end_date) {
					calendar.setEnd_date((Date)end_date);
				}
