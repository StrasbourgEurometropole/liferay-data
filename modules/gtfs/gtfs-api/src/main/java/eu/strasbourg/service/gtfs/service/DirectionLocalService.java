...
public interface DirectionLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DirectionLocalServiceUtil} to access the direction local service. Add custom service methods to {@link eu.strasbourg.service.gtfs.service.impl.DirectionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Direction getDirectionByUuidAndGroupId(java.lang.String uuid,
