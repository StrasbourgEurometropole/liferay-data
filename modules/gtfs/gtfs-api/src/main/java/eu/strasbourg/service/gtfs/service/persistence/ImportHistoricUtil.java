...
public class ImportHistoricUtil {
	...
	private static ServiceTracker
		<ImportHistoricPersistence, ImportHistoricPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			ImportHistoricPersistence.class);

		ServiceTracker<ImportHistoricPersistence, ImportHistoricPersistence>
			serviceTracker =
				new ServiceTracker
					<ImportHistoricPersistence, ImportHistoricPersistence>(
						bundle.getBundleContext(),
						ImportHistoricPersistence.class, null);
