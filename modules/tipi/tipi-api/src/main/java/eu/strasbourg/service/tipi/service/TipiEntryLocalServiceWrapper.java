 ...
 */
@ProviderType
public class TipiEntryLocalServiceWrapper implements TipiEntryLocalService,
	ServiceWrapper<TipiEntryLocalService> {
	...
	*/
	@Override
	public java.util.List<eu.strasbourg.service.tipi.model.TipiEntry> getTipiEntries(
		int start, int end) {
	...
	*/
	...
	public long dynamicQueryCount(
		...
		return _tipiEntryLocalService.dynamicQueryCount(dynamicQuery, projection);
	}
