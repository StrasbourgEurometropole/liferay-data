 ...
 * {@link eu.strasbourg.service.tipi.service.impl.TipiEntryLocalServiceImpl} and is the
...
public class TipiEntryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link eu.strasbourg.service.tipi.service.impl.TipiEntryLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	...
	public static eu.strasbourg.service.tipi.model.TipiEntry addPayment(
		java.util.Date date, java.lang.String type, java.lang.String status,
	...
	*/
	...
	public static java.util.List<eu.strasbourg.service.tipi.model.TipiEntry> getByDate(
		java.util.Date date) {
	...
	*/
	public static java.util.List<eu.strasbourg.service.tipi.model.TipiEntry> getTipiEntries(
		int start, int end) {
	...
	*/
	...
	private static ServiceTracker<TipiEntryLocalService, TipiEntryLocalService> _serviceTracker =
		ServiceTrackerFactory.open(TipiEntryLocalService.class);
}