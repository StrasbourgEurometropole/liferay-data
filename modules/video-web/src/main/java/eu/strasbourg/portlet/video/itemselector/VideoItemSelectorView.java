...
public class VideoItemSelectorView
	...
	public void renderHTML(ServletRequest servletRequest,
		...
		List<Video> videos = VideoLocalServiceUtil.findByKeyword(keywords,
			themeDisplay.getScopeGroupId(), (delta * cur) - delta,
			((delta * cur) + delta));

		long videosCount = VideoLocalServiceUtil.findByKeywordCount(
		...
		RequestDispatcher requestDispatcher = servletContext
			.getRequestDispatcher(
				"/video/item-selector/video-item-selector.jsp");
