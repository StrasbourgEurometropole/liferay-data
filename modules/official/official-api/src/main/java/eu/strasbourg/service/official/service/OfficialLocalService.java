...
public interface OfficialLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OfficialLocalServiceUtil} to access the official local service. Add custom service methods to {@link eu.strasbourg.service.official.service.impl.OfficialLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public List<Official> findByKeyword(java.lang.String keyword, long groupId,
		int start, int end);
