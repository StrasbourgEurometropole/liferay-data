...
public class AssociationSoap implements Serializable {
	...
	public static AssociationSoap[] toSoapModels(Association[] models) {
		AssociationSoap[] soapModels = new AssociationSoap[models.length];
	...
	public static AssociationSoap[][] toSoapModels(Association[][] models) {
		AssociationSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new AssociationSoap[models.length][models[0].length];
		}
		else {
			soapModels = new AssociationSoap[0][0];
		}
	...
	public static AssociationSoap[] toSoapModels(List<Association> models) {
		...
		return soapModels.toArray(new AssociationSoap[soapModels.size()]);
	}

	public AssociationSoap() {
	}
