...
public class ActivityCourseScheduleUtil {
	...
	* @return the matching activity course schedules
	*/
	public static List<ActivityCourseSchedule> findByActivityCoursePlaceAndPeriodId(
		long activityCoursePlaceId, long periodId) {
		return getPersistence()
				   .findByActivityCoursePlaceAndPeriodId(activityCoursePlaceId,
			periodId);
	}
	...
	*/
	public static List<ActivityCourseSchedule> findByActivityCoursePlaceAndPeriodId(
		...
		return getPersistence()
				   .findByActivityCoursePlaceAndPeriodId(activityCoursePlaceId,
			periodId, start, end, orderByComparator, retrieveFromCache);
	}
	...
	* @throws NoSuchActivityCourseScheduleException if a matching activity course schedule could not be found
	*/
	public static ActivityCourseSchedule findByActivityCoursePlaceAndPeriodId_First(
		long activityCoursePlaceId, long periodId,
		OrderByComparator<ActivityCourseSchedule> orderByComparator)
		throws eu.strasbourg.service.activity.exception.NoSuchActivityCourseScheduleException {
		return getPersistence()
				   .findByActivityCoursePlaceAndPeriodId_First(activityCoursePlaceId,
	...
	* @return the first matching activity course schedule, or <code>null</code> if a matching activity course schedule could not be found
	*/
	public static ActivityCourseSchedule fetchByActivityCoursePlaceAndPeriodId_First(
		long activityCoursePlaceId, long periodId,
		OrderByComparator<ActivityCourseSchedule> orderByComparator) {
		return getPersistence()
				   .fetchByActivityCoursePlaceAndPeriodId_First(activityCoursePlaceId,
			periodId, orderByComparator);
	}
	...
	* @throws NoSuchActivityCourseScheduleException if a matching activity course schedule could not be found
	*/
	public static ActivityCourseSchedule findByActivityCoursePlaceAndPeriodId_Last(
		long activityCoursePlaceId, long periodId,
		OrderByComparator<ActivityCourseSchedule> orderByComparator)
		throws eu.strasbourg.service.activity.exception.NoSuchActivityCourseScheduleException {
		return getPersistence()
				   .findByActivityCoursePlaceAndPeriodId_Last(activityCoursePlaceId,
			periodId, orderByComparator);
	}
	...
	* @return the last matching activity course schedule, or <code>null</code> if a matching activity course schedule could not be found
	*/
	public static ActivityCourseSchedule fetchByActivityCoursePlaceAndPeriodId_Last(
		long activityCoursePlaceId, long periodId,
		OrderByComparator<ActivityCourseSchedule> orderByComparator) {
		return getPersistence()
				   .fetchByActivityCoursePlaceAndPeriodId_Last(activityCoursePlaceId,
			periodId, orderByComparator);
	}
	...
	* @throws NoSuchActivityCourseScheduleException if a activity course schedule with the primary key could not be found
	*/
	public static ActivityCourseSchedule[] findByActivityCoursePlaceAndPeriodId_PrevAndNext(
		long activityCourseScheduleId, long activityCoursePlaceId,
		long periodId,
		OrderByComparator<ActivityCourseSchedule> orderByComparator)
		throws eu.strasbourg.service.activity.exception.NoSuchActivityCourseScheduleException {
		return getPersistence()
				   .findByActivityCoursePlaceAndPeriodId_PrevAndNext(activityCourseScheduleId,
			activityCoursePlaceId, periodId, orderByComparator);
	}
	...
	* @param periodId the period ID
	*/
	public static void removeByActivityCoursePlaceAndPeriodId(
		long activityCoursePlaceId, long periodId) {
		getPersistence()
			.removeByActivityCoursePlaceAndPeriodId(activityCoursePlaceId,
			periodId);
	}
	...
	* @return the number of matching activity course schedules
	*/
	public static int countByActivityCoursePlaceAndPeriodId(
		long activityCoursePlaceId, long periodId) {
		return getPersistence()
				   .countByActivityCoursePlaceAndPeriodId(activityCoursePlaceId,
			periodId);
	}
