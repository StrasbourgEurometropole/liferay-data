...
public class ActivityCoursePlaceUtil {
	...
	public static List<ActivityCoursePlace> findByActivityCourse(
		...
		return getPersistence().findByActivityCourse(
			activityCourseId, start, end, orderByComparator, retrieveFromCache);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			ActivityCoursePlacePersistence.class);

		ServiceTracker
			<ActivityCoursePlacePersistence, ActivityCoursePlacePersistence>
				serviceTracker =
					new ServiceTracker
						<ActivityCoursePlacePersistence,
						 ActivityCoursePlacePersistence>(
							 bundle.getBundleContext(),
							 ActivityCoursePlacePersistence.class, null);
