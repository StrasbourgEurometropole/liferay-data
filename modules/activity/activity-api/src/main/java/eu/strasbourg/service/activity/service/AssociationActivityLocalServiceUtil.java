...
/**
 * Provides the local service utility for AssociationActivity. This utility wraps
 * {@link eu.strasbourg.service.activity.service.impl.AssociationActivityLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class AssociationActivityLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link eu.strasbourg.service.activity.service.impl.AssociationActivityLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static eu.strasbourg.service.activity.model.AssociationActivity addAssociationActivity(
		eu.strasbourg.service.activity.model.AssociationActivity associationActivity) {
		return getService().addAssociationActivity(associationActivity);
	}

	/**
	* Crée une activité vide avec une PK, non ajouté à la base de donnée
	*/
	public static eu.strasbourg.service.activity.model.AssociationActivity createAssociationActivity(
		com.liferay.portal.kernel.service.ServiceContext sc)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().createAssociationActivity(sc);
	}
	...
	*/
	public static eu.strasbourg.service.activity.model.AssociationActivity createAssociationActivity(
		...
		return getService().createAssociationActivity(associationActivityId);
	}
	...
	*/
	public static eu.strasbourg.service.activity.model.AssociationActivity deleteAssociationActivity(
		eu.strasbourg.service.activity.model.AssociationActivity associationActivity) {
		return getService().deleteAssociationActivity(associationActivity);
	}
	...
	*/
	public static eu.strasbourg.service.activity.model.AssociationActivity deleteAssociationActivity(
		long associationActivityId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteAssociationActivity(associationActivityId);
	}

	public static eu.strasbourg.service.activity.model.AssociationActivity fetchAssociationActivity(
		long associationActivityId) {
		return getService().fetchAssociationActivity(associationActivityId);
	}
	...
	*/
	public static eu.strasbourg.service.activity.model.AssociationActivity fetchAssociationActivityByUuidAndGroupId(
		java.lang.String uuid, long groupId) {
		return getService()
				   .fetchAssociationActivityByUuidAndGroupId(uuid, groupId);
	}
	...
	* @throws PortalException if a association activity with the primary key could not be found
	*/
	public static eu.strasbourg.service.activity.model.AssociationActivity getAssociationActivity(
		long associationActivityId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getAssociationActivity(associationActivityId);
	}
	...
	*/
	public static eu.strasbourg.service.activity.model.AssociationActivity getAssociationActivityByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getAssociationActivityByUuidAndGroupId(uuid, groupId);
	}

	/**
	* Supprime une entité
	*/
	public static eu.strasbourg.service.activity.model.AssociationActivity removeAssociationActivity(
		long associationActivityId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().removeAssociationActivity(associationActivityId);
	}
	...
	*/
	public static eu.strasbourg.service.activity.model.AssociationActivity updateAssociationActivity(
		eu.strasbourg.service.activity.model.AssociationActivity associationActivity) {
		return getService().updateAssociationActivity(associationActivity);
	}
	...
	*/
	public static eu.strasbourg.service.activity.model.AssociationActivity updateAssociationActivity(
		...
		com.liferay.portal.kernel.service.ServiceContext sc)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().updateAssociationActivity(associationActivity, sc);
	}

	/**
	* Met à jour le statut de l'actvité de l'association par le framework workflow
	*/
	public static eu.strasbourg.service.activity.model.AssociationActivity updateStatus(
	...
	*/
	public static int getAssociationActivitiesCount() {
		return getService().getAssociationActivitiesCount();
	}
	...
	*/
	public static java.util.List<eu.strasbourg.service.activity.model.AssociationActivity> findByKeyword(
	...
	*/
	public static java.util.List<eu.strasbourg.service.activity.model.AssociationActivity> getAssociationActivities(
		int start, int end) {
		return getService().getAssociationActivities(start, end);
	}
	...
	*/
	public static java.util.List<eu.strasbourg.service.activity.model.AssociationActivity> getAssociationActivitiesByUuidAndCompanyId(
		java.lang.String uuid, long companyId) {
		return getService()
				   .getAssociationActivitiesByUuidAndCompanyId(uuid, companyId);
	}
	...
	*/
	public static java.util.List<eu.strasbourg.service.activity.model.AssociationActivity> getByAssociation(
		long associationId) {
	...
	*/
	public static java.util.List<eu.strasbourg.service.activity.model.AssociationActivity> getByGroupId(
		long groupId) {
	...
	*/
	...
	public static AssociationActivityLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<AssociationActivityLocalService, AssociationActivityLocalService> _serviceTracker =
		ServiceTrackerFactory.open(AssociationActivityLocalService.class);
}