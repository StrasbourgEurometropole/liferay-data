...
public class ActivityCourseSchedulePersistenceImpl extends BasePersistenceImpl<ActivityCourseSchedule>
	...
	private static final String _FINDER_COLUMN_ACTIVITYCOURSEPLACE_ACTIVITYCOURSEPLACEID_2 =
		"activityCourseSchedule.activityCoursePlaceId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_ACTIVITYCOURSEPLACEANDPERIODID =
		new FinderPath(ActivityCourseScheduleModelImpl.ENTITY_CACHE_ENABLED,
			ActivityCourseScheduleModelImpl.FINDER_CACHE_ENABLED,
			ActivityCourseScheduleImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByActivityCoursePlaceAndPeriodId",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ACTIVITYCOURSEPLACEANDPERIODID =
		new FinderPath(ActivityCourseScheduleModelImpl.ENTITY_CACHE_ENABLED,
			ActivityCourseScheduleModelImpl.FINDER_CACHE_ENABLED,
			ActivityCourseScheduleImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			...
			ActivityCourseScheduleModelImpl.ACTIVITYCOURSEPLACEID_COLUMN_BITMASK |
			ActivityCourseScheduleModelImpl.PERIODID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_ACTIVITYCOURSEPLACEANDPERIODID =
		new FinderPath(ActivityCourseScheduleModelImpl.ENTITY_CACHE_ENABLED,
			ActivityCourseScheduleModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByActivityCoursePlaceAndPeriodId",
			new String[] { Long.class.getName(), Long.class.getName() });
	 ...
	 */
	@Override
	public List<ActivityCourseSchedule> findByActivityCoursePlaceAndPeriodId(
		long activityCoursePlaceId, long periodId) {
		return findByActivityCoursePlaceAndPeriodId(activityCoursePlaceId,
	...
	public List<ActivityCourseSchedule> findByActivityCoursePlaceAndPeriodId(
		...
		OrderByComparator<ActivityCourseSchedule> orderByComparator) {
		return findByActivityCoursePlaceAndPeriodId(activityCoursePlaceId,
			periodId, start, end, orderByComparator, true);
	}
	...
	public List<ActivityCourseSchedule> findByActivityCoursePlaceAndPeriodId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ACTIVITYCOURSEPLACEANDPERIODID;
			finderArgs = new Object[] { activityCoursePlaceId, periodId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_ACTIVITYCOURSEPLACEANDPERIODID;
			finderArgs = new Object[] {
					activityCoursePlaceId, periodId,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (ActivityCourseSchedule activityCourseSchedule : list) {
					if ((activityCoursePlaceId != activityCourseSchedule.getActivityCoursePlaceId()) ||
							(periodId != activityCourseSchedule.getPeriodId())) {
						list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_ACTIVITYCOURSEPLACEANDPERIODID_ACTIVITYCOURSEPLACEID_2);

			query.append(_FINDER_COLUMN_ACTIVITYCOURSEPLACEANDPERIODID_PERIODID_2);
	...
	public ActivityCourseSchedule findByActivityCoursePlaceAndPeriodId_First(
		...
		OrderByComparator<ActivityCourseSchedule> orderByComparator)
		throws NoSuchActivityCourseScheduleException {
		ActivityCourseSchedule activityCourseSchedule = fetchByActivityCoursePlaceAndPeriodId_First(activityCoursePlaceId,
	...
	public ActivityCourseSchedule fetchByActivityCoursePlaceAndPeriodId_First(
		long activityCoursePlaceId, long periodId,
		OrderByComparator<ActivityCourseSchedule> orderByComparator) {
		List<ActivityCourseSchedule> list = findByActivityCoursePlaceAndPeriodId(activityCoursePlaceId,
				periodId, 0, 1, orderByComparator);
	...
	public ActivityCourseSchedule findByActivityCoursePlaceAndPeriodId_Last(
		...
		OrderByComparator<ActivityCourseSchedule> orderByComparator)
		throws NoSuchActivityCourseScheduleException {
		ActivityCourseSchedule activityCourseSchedule = fetchByActivityCoursePlaceAndPeriodId_Last(activityCoursePlaceId,
				periodId, orderByComparator);
	...
	public ActivityCourseSchedule fetchByActivityCoursePlaceAndPeriodId_Last(
		long activityCoursePlaceId, long periodId,
		OrderByComparator<ActivityCourseSchedule> orderByComparator) {
		int count = countByActivityCoursePlaceAndPeriodId(activityCoursePlaceId,
				periodId);
	...
	public ActivityCourseSchedule[] findByActivityCoursePlaceAndPeriodId_PrevAndNext(
		...
		try {
			...
			array[0] = getByActivityCoursePlaceAndPeriodId_PrevAndNext(session,
					activityCourseSchedule, activityCoursePlaceId, periodId,
					orderByComparator, true);

			array[1] = activityCourseSchedule;

			array[2] = getByActivityCoursePlaceAndPeriodId_PrevAndNext(session,
					activityCourseSchedule, activityCoursePlaceId, periodId,
					orderByComparator, false);
	...
	protected ActivityCourseSchedule getByActivityCoursePlaceAndPeriodId_PrevAndNext(
		Session session, ActivityCourseSchedule activityCourseSchedule,
		long activityCoursePlaceId, long periodId,
		OrderByComparator<ActivityCourseSchedule> orderByComparator,
		boolean previous) {
	...
	public void removeByActivityCoursePlaceAndPeriodId(
		long activityCoursePlaceId, long periodId) {
		for (ActivityCourseSchedule activityCourseSchedule : findByActivityCoursePlaceAndPeriodId(
				activityCoursePlaceId, periodId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(activityCourseSchedule);
		}
	}
	...
	public int countByActivityCoursePlaceAndPeriodId(
		long activityCoursePlaceId, long periodId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_ACTIVITYCOURSEPLACEANDPERIODID;

		Object[] finderArgs = new Object[] { activityCoursePlaceId, periodId };
	...
	private static final String _FINDER_COLUMN_ACTIVITYCOURSEPLACEANDPERIODID_ACTIVITYCOURSEPLACEID_2 =
		"activityCourseSchedule.activityCoursePlaceId = ? AND ";
	private static final String _FINDER_COLUMN_ACTIVITYCOURSEPLACEANDPERIODID_PERIODID_2 =
		"activityCourseSchedule.periodId = ?";
	...
	public ActivityCourseSchedule updateImpl(
		...
		if (isNew || !ActivityCourseScheduleModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((activityCourseScheduleModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ACTIVITYCOURSEPLACEANDPERIODID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						activityCourseScheduleModelImpl.getOriginalActivityCoursePlaceId(),
						activityCourseScheduleModelImpl.getOriginalPeriodId()
					};

				finderCache.removeResult(FINDER_PATH_COUNT_BY_ACTIVITYCOURSEPLACEANDPERIODID,
					args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ACTIVITYCOURSEPLACEANDPERIODID,
					args);

				args = new Object[] {
						activityCourseScheduleModelImpl.getActivityCoursePlaceId(),
						activityCourseScheduleModelImpl.getPeriodId()
					};
	...
	protected ActivityCourseSchedule toUnwrappedModel(
		...
		activityCourseScheduleImpl.setPeriodId(activityCourseSchedule.getPeriodId());
