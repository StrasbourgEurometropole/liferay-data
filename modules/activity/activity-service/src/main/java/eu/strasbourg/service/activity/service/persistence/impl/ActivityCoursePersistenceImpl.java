...
public class ActivityCoursePersistenceImpl extends BasePersistenceImpl<ActivityCourse>
	...
	protected void cacheUniqueFindersCache(
		ActivityCourseModelImpl activityCourseModelImpl, boolean isNew) {
		if (isNew) {
	...
	public ActivityCourse updateImpl(ActivityCourse activityCourse) {
		...
		if (isNew || !ActivityCourseModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		...
		clearUniqueFindersCache(activityCourseModelImpl);
		cacheUniqueFindersCache(activityCourseModelImpl, isNew);
