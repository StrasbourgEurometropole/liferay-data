        ...
        <div class="modal-content">
            ...
            <form>
                ...
                <div class="pro-wrapper">
                    ...
                    <div class="pro-row">
                        <div class="form-group form-triple">
                            <label for="nom-3"><liferay-ui:message key="modal.filepetition.user.username"/> <span class="required">*</span></label>
                            <input type="text" class="form-control" id="nom-3" placeholder="Dupond"/>
                        </div>
                        <div class="form-group form-triple">
                            <label for="prenom-3"><liferay-ui:message key="modal.filepetition.user.firstname"/></label>
                            <input type="text" class="form-control" id="prenom-3" placeholder="Jean"/>
                        </div>
                        <div class="form-group form-triple">
                            <label for="date-3"><liferay-ui:message key="modal.filepetition.user.birthday"/> <span class="required">*</span></label>
                            <input type="text" class="form-control frm_date" id="date-3" placeholder="jj/mm/aaaa" readonly="readonly"/>
                        </div>
                    </div>
                    <div class="pro-row">
                        <div class="form-group form-half">
                            <label for="adresse-3"><liferay-ui:message key="modal.filepetition.user.address"/> <span class="required">*</span></label>
                            <input type="text" class="form-control" id="adresse-3" />
                        </div>
                        <div class="form-group form-half">
                            <div class="form-city">
                                <label for="city-3"><liferay-ui:message key="modal.filepetition.user.city"/> <span class="required">*</span></label>
                                <input type="text" class="form-control" id="city-3" />
                            </div>
                            <div class="form-code">
                                <label for="code-3"><liferay-ui:message key="modal.filepetition.user.postalcode"/> <span class="required">*</span></label>
                    ...
                    <div class="pro-row">
                        <div class="form-group form-half">
                            <label for="email-3"><liferay-ui:message key="modal.filepetition.user.mail"/> <span class="required">*</span></label>
                            <input type="email" class="form-control" id="email-3" placeholder="jean.dupond@gmail.com">
                        </div>
                        <div class="form-group form-half">
                            <label for="tel-3"><liferay-ui:message key="modal.filepetition.user.phone"/></label>
                ...
                <div class="pro-optin form-checkbox">
                    <div>
                        ...
                        <label for="optin"><liferay-ui:message key="modal.filepetition.legalage"/></label>
                    </div>
                </div>
                <div class="pro-optin form-checkbox">
                    <div>
                        <input type="checkbox" id="optin-10" value="optin-3">
                        <label for="optin-10"><liferay-ui:message key="modal.filepetition.cnil"/></label>
                    </div>
                </div>
