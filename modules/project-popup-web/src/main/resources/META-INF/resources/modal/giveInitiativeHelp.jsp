...
<div class="pro-modal pro-bloc-pcs-form fade" id="modalAide"
	tabindex="-1" role="dialog" aria-labelledby="modalAide">
		...
		<div class="modal-content">
			...
			<form>
				<div class="pro-wrapper">
					<div class="pro-row">
						<div class="form-group form-half">
							<label for="nom">Nom <span class="required">*</span></label> <input
					...
					<div class="form-checkbox">
						...
						<div class="checkbox-inline">
							...
							<label for="inlineCheckbox2" class="checkbox-inline">De
								l'argent</label>
						</div>
						<div class="checkbox-inline">
							<input type="checkbox" id="inlineCheckbox3" value="option3">
							<label for="inlineCheckbox3" class="checkbox-inline">Un
								lieu</label>
						</div>
						<div class="checkbox-inline">
							<input type="checkbox" id="inlineCheckbox4" value="option4">
							<label for="inlineCheckbox4" class="checkbox-inline">Une
								expertise</label>
						</div>
					</div>
				...
				<div class="pro-optin form-checkbox">
					<div>
						<input type="checkbox" id="optin" value="optin"> <label
							for="optin">Je consens XXXX (Conditions CNIL à préciser)</label>
					</div>
				</div>
				<div class="pro-form-submit">
					<button type="submit" class="btn btn-default">Proposer mon
						aide</button>
				</div>
			</form>
		</div>
