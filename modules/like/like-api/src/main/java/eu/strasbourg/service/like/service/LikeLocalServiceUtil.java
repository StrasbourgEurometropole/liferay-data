 ...
 * {@link eu.strasbourg.service.like.service.impl.LikeLocalServiceImpl} and is the
...
public class LikeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link eu.strasbourg.service.like.service.impl.LikeLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	* @return the new like
	*/
	public static eu.strasbourg.service.like.model.Like createLike(long likeId) {
	...
	*/
	public static java.util.List<eu.strasbourg.service.like.model.Like> getByEntityIdAndTypeId(
	...
	*/
	public static java.util.List<eu.strasbourg.service.like.model.Like> getByEntityIdAndTypeIdAndIsDislike(
		long entityId, long typeId, boolean isDislike) {
		return getService()
				   .getByEntityIdAndTypeIdAndIsDislike(entityId, typeId,
			isDislike);
	}
	...
	*/
	public static java.util.List<eu.strasbourg.service.like.model.Like> getByPublikUser(
	...
	*/
	public static java.util.List<eu.strasbourg.service.like.model.Like> getLikes(
		int start, int end) {
	...
	*/
	public static void deleteLikeByEntityIdAndTypeAndIsDislike(long entityId,
		long typeId, boolean isDislike) {
		getService()
			.deleteLikeByEntityIdAndTypeAndIsDislike(entityId, typeId, isDislike);
	}
	...
	private static ServiceTracker<LikeLocalService, LikeLocalService> _serviceTracker =
		ServiceTrackerFactory.open(LikeLocalService.class);
}