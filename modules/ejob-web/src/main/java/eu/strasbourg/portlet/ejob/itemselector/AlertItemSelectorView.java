...
public class AlertItemSelectorView
	implements ItemSelectorView<AlertItemSelectorCriterion> {
	...
	@Override
	public Class<AlertItemSelectorCriterion> getItemSelectorCriterionClass() {
		return AlertItemSelectorCriterion.class;
	}
	...
	public void renderHTML(ServletRequest servletRequest,
		ServletResponse servletResponse,
						   AlertItemSelectorCriterion itemSelectorCriterion,
		...
		List<Alert> alerts = AlertLocalServiceUtil.findByKeyword(keywords,
			themeDisplay.getScopeGroupId(), (delta * cur) - delta,
			(delta * cur));

		long alertsCount = AlertLocalServiceUtil.findByKeywordCount(
			keywords, themeDisplay.getScopeGroupId());

		servletRequest.setAttribute("total", alertsCount);
		servletRequest.setAttribute("alerts", alerts);
		...
		RequestDispatcher requestDispatcher = servletContext
			.getRequestDispatcher(
				"/alert/item-selector/alert-item-selector.jsp");
