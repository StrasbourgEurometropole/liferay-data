 ...
 * {@link eu.strasbourg.service.oidc.service.impl.AnonymisationHistoricLocalServiceImpl} and is the
...
public class AnonymisationHistoricLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link eu.strasbourg.service.oidc.service.impl.AnonymisationHistoricLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static eu.strasbourg.service.oidc.model.AnonymisationHistoric addAnonymisationHistoric(
	...
	*/
	public static eu.strasbourg.service.oidc.model.AnonymisationHistoric createAnonymisationHistoric(
	...
	*/
	public static eu.strasbourg.service.oidc.model.AnonymisationHistoric createAnonymisationHistoric(
		...
		return getService().createAnonymisationHistoric(anonymisationHistoricId);
	}
	...
	*/
	public static eu.strasbourg.service.oidc.model.AnonymisationHistoric deleteAnonymisationHistoric(
		eu.strasbourg.service.oidc.model.AnonymisationHistoric anonymisationHistoric) {
	...
	*/
	public static eu.strasbourg.service.oidc.model.AnonymisationHistoric deleteAnonymisationHistoric(
		long anonymisationHistoricId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteAnonymisationHistoric(anonymisationHistoricId);
	}

	public static eu.strasbourg.service.oidc.model.AnonymisationHistoric fetchAnonymisationHistoric(
		long anonymisationHistoricId) {
	...
	*/
	public static eu.strasbourg.service.oidc.model.AnonymisationHistoric fetchAnonymisationHistoricByUuidAndGroupId(
	...
	* @throws PortalException if a anonymisation historic with the primary key could not be found
	*/
	public static eu.strasbourg.service.oidc.model.AnonymisationHistoric getAnonymisationHistoric(
		long anonymisationHistoricId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static eu.strasbourg.service.oidc.model.AnonymisationHistoric getAnonymisationHistoricByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
	...
	*/
	public static eu.strasbourg.service.oidc.model.AnonymisationHistoric removeAnonymisationHistoric(
		long anonymisationHistoricId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().removeAnonymisationHistoric(anonymisationHistoricId);
	}
	...
	*/
	public static eu.strasbourg.service.oidc.model.AnonymisationHistoric updateAnonymisationHistoric(
		eu.strasbourg.service.oidc.model.AnonymisationHistoric anonymisationHistoric) {
	...
	*/
	public static eu.strasbourg.service.oidc.model.AnonymisationHistoric updateAnonymisationHistoric(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .updateAnonymisationHistoric(anonymisationHistoric, sc);
	}

	/**
	* Met à jour le statut de l'entree d'anonymisation par le framework workflow
	*/
	public static eu.strasbourg.service.oidc.model.AnonymisationHistoric updateStatus(
	...
	*/
	public static java.util.List<eu.strasbourg.service.oidc.model.AnonymisationHistoric> findByKeyword(
	...
	*/
	public static java.util.List<eu.strasbourg.service.oidc.model.AnonymisationHistoric> getAnonymisationHistorics(
		int start, int end) {
	...
	*/
	public static java.util.List<eu.strasbourg.service.oidc.model.AnonymisationHistoric> getAnonymisationHistoricsByUuidAndCompanyId(
	...
	*/
	public static java.util.List<eu.strasbourg.service.oidc.model.AnonymisationHistoric> getAnonymisationHistoricsByUuidAndCompanyId(
		...
		return getService()
				   .getAnonymisationHistoricsByUuidAndCompanyId(uuid,
	...
	*/
	public static java.util.List<eu.strasbourg.service.oidc.model.AnonymisationHistoric> getByGroupId(
		long groupId) {
	...
	*/
	...
	private static ServiceTracker<AnonymisationHistoricLocalService, AnonymisationHistoricLocalService> _serviceTracker =
		ServiceTrackerFactory.open(AnonymisationHistoricLocalService.class);
}