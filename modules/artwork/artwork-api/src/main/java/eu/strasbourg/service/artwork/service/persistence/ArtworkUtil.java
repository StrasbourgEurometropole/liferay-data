...
public class ArtworkUtil {
	...
	private static ServiceTracker<ArtworkPersistence, ArtworkPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ArtworkPersistence.class);

		ServiceTracker<ArtworkPersistence, ArtworkPersistence> serviceTracker =
			new ServiceTracker<ArtworkPersistence, ArtworkPersistence>(
				bundle.getBundleContext(), ArtworkPersistence.class, null);
