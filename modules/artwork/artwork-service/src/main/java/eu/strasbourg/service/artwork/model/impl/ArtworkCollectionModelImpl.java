 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link ArtworkCollectionModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ArtworkCollectionImpl}.
 * </p>
 *
 * @author BenjaminBini
...
@JSON(strict = true)
@ProviderType
public class ArtworkCollectionModelImpl extends BaseModelImpl<ArtworkCollection>
	implements ArtworkCollectionModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public static List<ArtworkCollection> toModels(
		...
		List<ArtworkCollection> models = new ArrayList<ArtworkCollection>(soapModels.length);
	...
	public void setContributors(String contributors, Locale locale,
		...
		if (Validator.isNotNull(contributors)) {
			setContributors(LocalizationUtil.updateLocalization(
					getContributors(), "Contributors", contributors,
					languageId, defaultLanguageId));
		}
		else {
			setContributors(LocalizationUtil.removeLocalization(
	...
	public void setContributorsMap(Map<Locale, String> contributorsMap,
		...
		setContributors(LocalizationUtil.updateLocalization(contributorsMap,
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(getCompanyId(),
			ArtworkCollection.class.getName(), getPrimaryKey());
	}
	...
	public void prepareLocalizedFieldsForImport() throws LocaleException {
		...
		Locale defaultImportLocale = LocalizationUtil.getDefaultImportLocale(ArtworkCollection.class.getName(),
	...
	public void prepareLocalizedFieldsForImport(Locale defaultImportLocale)
		...
		if (Validator.isNull(contributors)) {
			setContributors(getContributors(modelDefaultLanguageId),
				defaultLocale);
		}
		else {
			setContributors(getContributors(defaultLocale), defaultLocale,
				defaultLocale);
		}
	}
	...
	public ArtworkCollection toEscapedModel() {
		if (_escapedModel == null) {
			_escapedModel = (ArtworkCollection)ProxyUtil.newProxyInstance(_classLoader,
	...
	public void resetOriginalValues() {
		...
		artworkCollectionModelImpl._originalUuid = artworkCollectionModelImpl._uuid;

		artworkCollectionModelImpl._originalGroupId = artworkCollectionModelImpl._groupId;

		artworkCollectionModelImpl._setOriginalGroupId = false;

		artworkCollectionModelImpl._originalCompanyId = artworkCollectionModelImpl._companyId;
	...
	public CacheModel<ArtworkCollection> toCacheModel() {
		ArtworkCollectionCacheModel artworkCollectionCacheModel = new ArtworkCollectionCacheModel();
	...
	private static final ClassLoader _classLoader = ArtworkCollection.class.getClassLoader();
