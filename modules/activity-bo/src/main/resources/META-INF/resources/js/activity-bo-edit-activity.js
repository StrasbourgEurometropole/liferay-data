// On garde une référence globale aux autofields
var autoFields;
...
jQuery(function() {
	...
	$('#place-fields').off('click').on('click', '.show-autocomplete-place',  function(e) {
		e.preventDefault();
		...
		$('.place-manual option', $(this).closest('.row-fields')).attr('selected', false);
	})
	.on('click', '.show-manual-place', function(e) {
		...
		$('.place-autocomplete option', $(this).closest('.row-fields')).attr('selected', false);
	});
