 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link InterestModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link InterestImpl}.
 * </p>
 *
 * @author BenjaminBini
 * @see InterestImpl
...
@JSON(strict = true)
@ProviderType
public class InterestModelImpl extends BaseModelImpl<Interest>
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(getCompanyId(),
			Interest.class.getName(), getPrimaryKey());
	}
	...
	public void prepareLocalizedFieldsForImport() throws LocaleException {
		...
		Locale defaultImportLocale = LocalizationUtil.getDefaultImportLocale(Interest.class.getName(),
	...
	public Interest toEscapedModel() {
		if (_escapedModel == null) {
			_escapedModel = (Interest)ProxyUtil.newProxyInstance(_classLoader,
	...
	public int compareTo(Interest interest) {
		...
		value = DateUtil.compareTo(getModifiedDate(), interest.getModifiedDate());
	...
	public String toXmlString() {
		...
		sb.append("eu.strasbourg.service.interest.model.Interest");
	...
	private static final ClassLoader _classLoader = Interest.class.getClassLoader();
