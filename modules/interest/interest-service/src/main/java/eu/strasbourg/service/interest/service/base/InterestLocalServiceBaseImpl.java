 ...
 */
@ProviderType
public abstract class InterestLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements InterestLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link eu.strasbourg.service.interest.service.InterestLocalServiceUtil} to access the interest local service.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Interest.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return interestPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(interestLocalService);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setAddCriteriaMethod(new ActionableDynamicQuery.AddCriteriaMethod() {
				...
				public void addCriteria(DynamicQuery dynamicQuery) {
					...
					if (portletDataContext.isInitialPublication()) {
						...
						StagedModelDataHandler<?> stagedModelDataHandler = StagedModelDataHandlerRegistryUtil.getStagedModelDataHandler(Interest.class.getName());
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<Interest>() {
				@Override
	 ...
	 */
	@Override
	public List<Interest> getInterestsByUuidAndCompanyId(String uuid,
		long companyId) {
	...
	public List<Interest> getInterestsByUuidAndCompanyId(String uuid,
		...
		return interestPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	 ...
	 */
	public eu.strasbourg.service.interest.service.UserInterestLocalService getUserInterestLocalService() {
	...
	public void setUserInterestLocalService(
		eu.strasbourg.service.interest.service.UserInterestLocalService userInterestLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("eu.strasbourg.service.interest.model.Interest",
	...
	@BeanReference(type = eu.strasbourg.service.interest.service.UserInterestLocalService.class)
	protected eu.strasbourg.service.interest.service.UserInterestLocalService userInterestLocalService;
