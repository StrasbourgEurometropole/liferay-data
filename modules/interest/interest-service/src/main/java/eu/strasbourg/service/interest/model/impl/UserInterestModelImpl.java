	...
	static {
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<UserInterest, Object>() {
				...
				@Override
				public void accept(
					UserInterest userInterest, Object interestId) {

					userInterest.setInterestId((Long)interestId);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<UserInterest, Object>() {
				...
				@Override
				public void accept(
					UserInterest userInterest, Object publikUserId) {

					userInterest.setPublikUserId((String)publikUserId);
				}
