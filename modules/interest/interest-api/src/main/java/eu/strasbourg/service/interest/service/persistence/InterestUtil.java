...
public class InterestUtil {
	...
	private static ServiceTracker<InterestPersistence, InterestPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(InterestPersistence.class);

		ServiceTracker<InterestPersistence, InterestPersistence>
			serviceTracker =
				new ServiceTracker<InterestPersistence, InterestPersistence>(
					bundle.getBundleContext(), InterestPersistence.class, null);
