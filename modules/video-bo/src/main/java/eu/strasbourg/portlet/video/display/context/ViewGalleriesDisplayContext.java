...
public class ViewGalleriesDisplayContext {
	...
	public SearchContainer<VideoGallery> getSearchContainer()
		...
		if (this._searchContainer == null) {
			this._searchContainer = new SearchContainer<VideoGallery>(
	...
	public List<VideoGallery> getGalleries() throws PortalException {
		if (this._galleries == null) {
			...
			Hits hits = SearchHelper.getBOSearchHits(searchContext,
				...
				this.getSearchContainer().getEnd(), VideoGallery.class.getName(),
			...
			int count = (int) SearchHelper.getBOSearchCount(searchContext,
				VideoGallery.class.getName(), this._themeDisplay.getScopeGroupId(),
				this.getFilterCategoriesIds(), keywords);
	...
	public List<AssetVocabulary> getVocabularies() {
		if (this._vocabularies == null) {
			this._vocabularies = VideoGalleryLocalServiceUtil
	...
	private SearchContainer<VideoGallery> _searchContainer;
