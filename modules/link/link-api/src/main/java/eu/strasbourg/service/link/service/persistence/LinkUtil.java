...
public class LinkUtil {
	...
	private static ServiceTracker<LinkPersistence, LinkPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(LinkPersistence.class);

		ServiceTracker<LinkPersistence, LinkPersistence> serviceTracker =
			new ServiceTracker<LinkPersistence, LinkPersistence>(
				bundle.getBundleContext(), LinkPersistence.class, null);
