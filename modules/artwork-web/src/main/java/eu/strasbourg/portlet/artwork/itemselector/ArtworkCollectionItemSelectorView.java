...
public class ArtworkCollectionItemSelectorView
	implements ItemSelectorView<ArtworkCollectionItemSelectorCriterion> {
	...
	@Override
	public Class<ArtworkCollectionItemSelectorCriterion> getItemSelectorCriterionClass() {
		return ArtworkCollectionItemSelectorCriterion.class;
	}
	...
	public void renderHTML(ServletRequest servletRequest,
		...
		ArtworkCollectionItemSelectorCriterion itemSelectorCriterion,
		...
		List<ArtworkCollection> collections = ArtworkCollectionLocalServiceUtil
			.findByKeyword(keywords, themeDisplay.getSiteGroupIdOrLiveGroupId(),
				(delta * cur) - delta, ((delta * cur) + delta));

		long collectionsCount = ArtworkCollectionLocalServiceUtil.findByKeywordCount(
		...
		RequestDispatcher requestDispatcher = servletContext
			.getRequestDispatcher(
				"/artwork-collection/item-selector/collection-item-selector.jsp");
