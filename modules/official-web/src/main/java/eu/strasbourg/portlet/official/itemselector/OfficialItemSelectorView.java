...
public class OfficialItemSelectorView
	implements ItemSelectorView<OfficialItemSelectorCriterion> {
	...
	@Reference(target = "(osgi.web.symbolicname=official.web)", unbind = "-")
	public void setServletContext(ServletContext servletContext) {
		this._servletContext = servletContext;
	}

	@Override
	public Class<OfficialItemSelectorCriterion> getItemSelectorCriterionClass() {
	...
	public void renderHTML(ServletRequest servletRequest,
		...
		OfficialItemSelectorCriterion itemSelectorCriterion,
		...
		servletRequest.setAttribute("total", officialsCount);
		servletRequest.setAttribute("officials", officials);
		...
		RequestDispatcher requestDispatcher = servletContext
			.getRequestDispatcher(
				"/official/item-selector/official-item-selector.jsp");
