	...
	static {
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<Strasbourg, Object>() {
				...
				@Override
				public void accept(Strasbourg strasbourg, Object uuid) {
					strasbourg.setUuid((String)uuid);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<Strasbourg, Object>() {
				...
				@Override
				public void accept(Strasbourg strasbourg, Object id) {
					strasbourg.setId((Long)id);
				}
