...
public class StrasbourgUtil {
	...
	private static ServiceTracker<StrasbourgPersistence, StrasbourgPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(StrasbourgPersistence.class);

		ServiceTracker<StrasbourgPersistence, StrasbourgPersistence>
			serviceTracker =
				new ServiceTracker
					<StrasbourgPersistence, StrasbourgPersistence>(
						bundle.getBundleContext(), StrasbourgPersistence.class,
						null);
