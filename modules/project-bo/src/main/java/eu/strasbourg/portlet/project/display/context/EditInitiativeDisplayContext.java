...
public class EditInitiativeDisplayContext {
	...
	public EditInitiativeDisplayContext(RenderRequest request,
	...
	public String getDefaultPlaceIndexes() throws PortalException {
		if (this.getInitiative() != null) {
			List<PlacitPlace> places = this.getInitiative().getPlacitPlaces();
			String indexes = "0";
