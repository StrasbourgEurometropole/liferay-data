	...
	public void exportBudgetsParticipatifs(OutputStream stream, List<BudgetParticipatif> budgetsParticipatifs) {
		...
		for (BudgetParticipatif budgetParticipatif : budgetsParticipatifs) {
			...
			Object[] budgetParticipatifRow = {
				...
				budgetParticipatif.getDescription(),
				budgetParticipatif.getBudget(),
				budgetParticipatif.getMotif(),
				budgetParticipatif.getCitoyenLastname(),
				budgetParticipatif.getCitoyenFirstname(),
				budgetParticipatif.getCitoyenAdresse(),
				budgetParticipatif.getCitoyenPostalCode(),
				...
				budgetParticipatif.getPlaceTextArea(),
