		...
		for (Offer offer : offers) {
			try {
				...
				Object[] offerRow = {
						...
						grade5,
						levelStudy,
						offer.getIntroduction(Locale.FRANCE),
						offer.getActivities(Locale.FRANCE),
						offer.getProfil(Locale.FRANCE),
						offer.getConditions(Locale.FRANCE),
						offer.getAvantages(Locale.FRANCE),
						families,
