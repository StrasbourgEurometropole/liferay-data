                ...
                <#list picture.getSiblings() as cur_picture>
                    <blockquote class="mns-bloc-testi row">
                        <figure class="col-sm-3 col-xs-12">
                            <img src="/o/noel-theme/images/img-testimonial.png" alt="Image Testimonial" width="190" height="190" />
                        </figure>
                        <div class="col-sm-9 col-xs-12 text-content">
                            ...
                            <a href="${cur_picture.getChildren()[4].getData()}" class="link">${cur_picture.getChildren()[3].getData()}</a>
                        </div>
                    </blockquote>
                </#list>
            </div>
