    ...
    <div class="agenda-body agenda-carousel owl-agenda owl-carousel owl-theme">  
        <#list entries as curEntry>
            ...
            <div class="event-content"> 
                <a href="${homeURL}evenement/-/entity/id/${entry.eventId}/${entry.getTitle(locale)}">
                ...
                <div class="event-meta"> 
                    ...
                    <a class="btn-tps-forts" href="${homeURL}evenement/-/entity/id/${entry.eventId}/${entry.getTitle(locale)}">
