...
<div class="container mns-top-10">
            ...
            <div class="col-lg-7 col-md-6 col-sm-6 col-xs-12 pull-right order-1">
                ...
                <a href="#">
                    ...
                    <figure class="mns-wrapper-img mns-wrapper-img-top1">
                        <img src="${subtitle.siblings[0].children[4].data}" alt="${subtitle.siblings[0].children[0].data}" width="670" height="750" class="fit-cover" />
                    </figure>
                </a>
            </div>
        </div>
    ...
    <#if (subtitle.siblings?size > 2)>
        <img src="/o/noel-theme/images/parallax-deco-triangle.svg" alt="deco parallax" class="hidden-xs mns-para para-triangle" data-stellar-offset-parent="true" data-stellar-vertical-offset="-150" data-stellar-ratio="1.25" />
        <div class="row">
            <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 order-2">
    ...
    <#if (subtitle.siblings?size > 6)>
        <img src="/o/noel-theme/images/parallax-deco-beige.png" alt="deco parallax" class="hidden-xs mns-para para-elipse" data-stellar-offset-parent="true" data-stellar-vertical-offset="-150" data-stellar-ratio="1.25" width="396" height="399" />
        <div class="row">
    ...
    <#if (subtitle.siblings?size > 9)>
        <img src="/o/noel-theme/images/deco-stars-grey.png" alt="deco parallax" class="hidden-xs mns-para para-stars" data-stellar-offset-parent="true" data-stellar-vertical-offset="-150" data-stellar-ratio="1.25" width="396" height="399" />
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
