        ...
        <div class="page-header-title-and-share">
            ...
            <div class="page-header-share">
                ...
                <div class="page-header-share-buttons">
                    ...
                    <a href="https://twitter.com/intent/tweet?text=${page.getName(locale)} ${portalUtil.getHomeURL(request)}${layout.getFriendlyURL(locale)} via @StrasCulture"><div class="twitter"></div></a>
                </div>
            </div>
        </div>
